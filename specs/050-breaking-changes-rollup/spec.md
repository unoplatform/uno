...
- [x] **BC01** — Remove legacy templated-parent mechanism  `d3·L` · #18672
  ...
  - Files: `src/Uno.UI/UI/Xaml/FrameworkTemplate.cs`, `src/Uno.UI/UI/Xaml/TemplatedParentScope.cs` (deleted), `src/Uno.UI/UI/Xaml/ControlTemplate.cs`, `src/Uno.UI/UI/Xaml/TemplateMaterializationSettings.cs`, `src/Uno.UI/UI/Xaml/Markup/Reader/XamlObjectBuilder.cs`
