...
- [x] `src/Uno.UI.RemoteControl.DevServer.Tests/Tools/ToolRegistryTests.cs` — 46 tests (added concurrency/reentrancy stress, validation, timeout, and param-model coverage; file `#nullable enable`).
...
- **Runtime**: ran the MTP test assembly directly → **46 passed, 0 failed**.
  ```
