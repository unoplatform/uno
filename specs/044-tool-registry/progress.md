...
- [x] `src/Uno.UI.RemoteControl.DevServer.Tests/Tools/ToolRegistryTests.cs` — 45 tests (added concurrency/reentrancy stress, validation, timeout, and param-model coverage; file `#nullable enable`).
...
- **Runtime**: ran the MTP test assembly directly → **45 passed, 0 failed**.
  ```
