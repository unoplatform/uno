...
> **For agentic workers:** Implement this plan task-by-task, using the repo's standard skill set (see `AGENTS.md`). Steps use checkbox (`- [ ]`) syntax for tracking progress.
