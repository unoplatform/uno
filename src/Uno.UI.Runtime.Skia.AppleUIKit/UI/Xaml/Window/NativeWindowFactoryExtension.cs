...
internal class NativeWindowFactoryExtension : INativeWindowFactoryExtension
{
	...
	// there is no window to close in the first place. A window whose scene UIKit has already
	// disconnected opts out per-window, via NativeWindowWrapper.IsClosingCancellable.
	public bool SupportsClosingCancellation => SupportsMultipleWindows;
