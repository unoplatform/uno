...
internal sealed class InvisibleTextBoxFloatingCursor
{
	...
	{
		_origin = point;
		IsActive = extension?.ProcessCaretDragGesture(TextBoxCore.CaretDragPhase.Begin, default) == true;
	}
	...
	public void Update(InvisibleTextBoxViewExtension? extension, CGPoint point)
	{
		...
		IsActive = extension?.ProcessCaretDragGesture(TextBoxCore.CaretDragPhase.Update, offset) == true;
	}
