...
MCP-INDEX: Structured metadata to help the documentation MCP indexer.
{
  "uid": "Uno.DevServer",
  "title": "Dev Server",
  "summary": "Uno Platform Dev Server: purpose, startup behavior, CLI, Hot Reload, troubleshooting.",
  "keywords": [
    "Dev Server",
    "Hot Reload",
    "IDE integration",
  ...
  "commands": [
    {
      "tool": "uno-devserver",
      "verbs": ["start", "stop", "list", "cleanup", "login"],
      "options": ["--mcp", "--port", "--workingDir", "--timeoutMs"]
    },
    {
      "host": "Uno.UI.RemoteControl.Host",
      "options": ["--httpPort", "--ppid", "--ideChannel", "--solution", "--command", "--workingDir", "--timeoutMs"]
    }
  ],
  "ports": {
    "property": "UnoRemoteControlPort",
    "location": "<ProjectName>.csproj.user"
  },
  "startupConditions": [
    "Uno Platform packages referenced",
