...
namespace Uno.Storage.Pickers
{
	public static class MimeTypeMapping
	{
		public static string? GetMimeType(string fileExtension)
		{
			...
			if (_knownMimeTypes.TryGetValue(fileExtension, out var knownMimeType))
			{
		...
		private static readonly Dictionary<string, string> _knownMimeTypes = new Dictionary<string, string>()
		{
			{".aac", "audio/aac"},
