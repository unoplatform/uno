...
namespace Windows.ApplicationModel.Activation
{
	public partial class BackgroundActivatedEventArgs : IBackgroundActivatedEventArgs
	{
		...
		// below are two "additions" to API, as it has to be called from Android application using Uno,
		// to be exact, they are called from Shared/App.xaml.cs,
		// see src/SolutionTemplate/UnoSolutionTemplate/Shared/App.xaml.cs 
