...
public sealed class AppTaskContent
{
	...
	/// </summary>
	/// <param name="assets">The assets generated by the task. At least one asset is required.</param>
	...
	public static AppTaskContent CreateGeneratedAssetsResult(AppTaskResultAsset[] assets)
	{
		...
		{
			throw new ArgumentException("At least one generated asset is required.", nameof(assets));
		}
