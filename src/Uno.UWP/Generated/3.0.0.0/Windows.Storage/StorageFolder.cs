...
namespace Windows.Storage
{
	...
	public  partial class StorageFolder : global::Windows.Storage.IStorageFolder,global::Windows.Storage.IStorageItem,global::Windows.Storage.Search.IStorageFolderQueryOperations,global::Windows.Storage.IStorageItemProperties,global::Windows.Storage.IStorageItemProperties2,global::Windows.Storage.IStorageItem2,global::Windows.Storage.IStorageFolder2,global::Windows.Storage.IStorageItemPropertiesWithProvider
	{
		...
		public  string Name
		{
			get
			{
				throw new global::System.NotImplementedException("The member string StorageFolder.Name is not implemented in Uno.");
			}
		}
		#endif
		#if false || false || false || false
		...
		public  string Path
		{
			get
			{
				throw new global::System.NotImplementedException("The member string StorageFolder.Path is not implemented in Uno.");
			}
		}
		#endif
		#if __ANDROID__ || __IOS__ || NET46 || __WASM__
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncOperation<StorageFile> StorageFolder.CreateFileAsync(string desiredName, CreationCollisionOption options) is not implemented in Uno.");
		}
		#endif
		#if false || false || false || false
		[global::Uno.NotImplemented]
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncOperation<StorageFolder> StorageFolder.CreateFolderAsync(string desiredName) is not implemented in Uno.");
		}
		#endif
		#if false || false || false || false
		[global::Uno.NotImplemented]
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncOperation<StorageFile> StorageFolder.GetFileAsync(string name) is not implemented in Uno.");
		}
		#endif
		#if false || false || false || false
		[global::Uno.NotImplemented]
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncOperation<StorageFolder> StorageFolder.GetFolderAsync(string name) is not implemented in Uno.");
		}
		#endif
		#if false || false || false || false
		[global::Uno.NotImplemented]
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncOperation<IStorageItem> StorageFolder.GetItemAsync(string name) is not implemented in Uno.");
		}
		#endif
		#if __ANDROID__ || __IOS__ || NET46 || __WASM__
		[global::Uno.NotImplemented]
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncAction StorageFolder.DeleteAsync() is not implemented in Uno.");
		}
		#endif
		#if __ANDROID__ || __IOS__ || NET46 || __WASM__
		[global::Uno.NotImplemented]
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncOperation<IStorageItem> StorageFolder.TryGetItemAsync(string name) is not implemented in Uno.");
		}
		#endif
		...
		{
			throw new global::System.NotImplementedException("The member IAsyncOperation<StorageFolder> StorageFolder.GetFolderFromPathAsync(string path) is not implemented in Uno.");
		}
		#endif
