...
namespace System.IO
{
	public static partial class WindowsRuntimeStreamExtensions
	{
		...
		// "windowsruntimeStream" (lowercase 'r') matches the WinAppSDK/CsWinRT metadata, not the .NET BCL
		// casing — the sync generator enforces this name, so do not "correct" it to windowsRuntimeStream.
