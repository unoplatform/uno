...
{
	[Sample("Microsoft.UI.Xaml.Media", Name = "XamlCompositionBrushBase", Description = "Provides a base class used to create XAML brushes that paint an area with a CompositionBrush.", IsManualTest = true)]
