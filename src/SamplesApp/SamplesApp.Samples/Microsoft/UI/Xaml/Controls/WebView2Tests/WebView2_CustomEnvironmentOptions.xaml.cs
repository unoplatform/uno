...
namespace UITests.Microsoft_UI_Xaml_Controls.WebView2Tests
{
	...
	public sealed partial class WebView2_CustomEnvironmentOptions : Page
	{
		public WebView2_CustomEnvironmentOptions()
		{
		...
		private async void OnApplyClick(object sender, RoutedEventArgs e)
		{
			try
			{
				...
				if (WebViewHost.Content is Microsoft.UI.Xaml.Controls.WebView2 previous)
				{
					previous.Close();
				}
				...
				{
					StatusText.Text = $"Initialization failed: {initializationError?.Message}";
					return;
				}
