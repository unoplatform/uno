...
{
	[SampleControlInfo("LayoutTestControl", nameof(TextBlockTest))]
	public sealed partial class TextBlockTest : UserControl
	{
		...
		{
			this.MyContent.Text = "Test +" + Rand.Next(100000);
		}
	}
}
