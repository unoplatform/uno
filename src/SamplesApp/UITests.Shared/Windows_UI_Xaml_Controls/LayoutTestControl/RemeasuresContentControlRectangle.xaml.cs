...
{
	[SampleControlInfo("LayoutTestControl", nameof(RemeasuresContentControlRectangle))]
	public sealed partial class RemeasuresContentControlRectangle : UserControl
	{
		public int MeasureCount { get; set; } = 0;
		private Random Rand = new Random(1000);

		public RemeasuresContentControlRectangle()
		{
		...
		private void ChangeContentClick(object sender, RoutedEventArgs e)
		{
			...
			this.ContentRectangle.Width = width;
			this.ContentRectangle.Height = width;
		}
