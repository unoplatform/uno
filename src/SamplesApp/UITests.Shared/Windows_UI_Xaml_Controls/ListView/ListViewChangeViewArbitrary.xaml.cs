...
{
	[Sample("ListView", Name = "ListViewChangeViewArbitrary", typeof(ListViewViewModel), Description = "ListView sample allowing ChangeView to be called with any value and animations enabled or disabled")]
