...
{
	[SampleControlInfoAttribute("ListView", "ListViewChangeHeight", typeof(ListViewViewModel), description: "ListView with variable-height items whose available height can be changed. This shouldn't screw up the sizes of the items.")]
