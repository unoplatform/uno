...
namespace UITests.Shared.Windows_UI_Xaml_Controls.Button
{
	public partial class VisualStateProbeControl : ContentControl
	{
		...
		public static DependencyProperty CurrentStateProperty { get ; } =
			DependencyProperty.Register("CurrentState", typeof(string), typeof(VisualStateProbeControl), new FrameworkPropertyMetadata("<Unset>", (o, e) => ((VisualStateProbeControl)o).OnCurrentStateChanged((string)e.NewValue)));
		...
		public static DependencyProperty ProbeLabelProperty { get ; } =
			DependencyProperty.Register("ProbeLabel", typeof(string), typeof(VisualStateProbeControl), new FrameworkPropertyMetadata(defaultValue: "", propertyChangedCallback: (o, e) => ((VisualStateProbeControl)o).ApplyValue()));
