...
{
	[Sample("TextBox", "PasswordBox_PasswordChar", IsManualTest = true, Description = "PasswordChar is supported on Skia targets. Setting its value should change the password char accordingly.")]
