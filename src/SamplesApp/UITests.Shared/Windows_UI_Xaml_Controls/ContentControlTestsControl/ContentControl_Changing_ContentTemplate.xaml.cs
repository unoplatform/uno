...
{
	[Sample("ContentControl", Name = "ContentControl_Changing_ContentTemplate", Description = "ContentControl where ContentTemplate can be toggled between non-null and null. Content view should be visible when null.")]
