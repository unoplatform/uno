...
{
	[SampleControlInfo("GridView", nameof(GridView_Item_TextBlock_And_Button), typeof(ListViewViewModel), description: "On Android, the TextBlock is trimmed and the button doesn't appear.")]
