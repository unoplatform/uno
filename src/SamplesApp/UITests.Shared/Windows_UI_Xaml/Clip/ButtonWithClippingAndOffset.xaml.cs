...
{
	[SampleControlInfoAttribute("Clip", "ButtonWithClippingAndOffset", typeof(nVentive.Umbrella.Presentation.Light.ViewModelBase), description: "Button with Clip set to offset rectangle. Touch should be detected correctly.")]
