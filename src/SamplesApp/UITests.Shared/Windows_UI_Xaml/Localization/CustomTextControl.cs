...
namespace UITests.Shared.Windows_UI_Xaml.Localization
{
	public partial class CustomTextControl : ContentControl
	{
		...
		public static DependencyProperty CustomTextProperty { get ; } =
			DependencyProperty.Register("CustomText", typeof(string), typeof(CustomTextControl), new FrameworkPropertyMetadata(defaultValue: null, propertyChangedCallback: (o, __) => ((CustomTextControl)o).OnPropertyChanged()));
		...
		public static DependencyProperty CustomTextObjProperty { get ; } =
			DependencyProperty.Register("CustomTextObj", typeof(object), typeof(CustomTextControl), new FrameworkPropertyMetadata(defaultValue: null, propertyChangedCallback: (o, __) => ((CustomTextControl)o).OnPropertyChanged()));
