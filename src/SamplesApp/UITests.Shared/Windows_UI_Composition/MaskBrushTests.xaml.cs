...
{
	[Sample("Microsoft.UI.Composition", Name = "CompositionMaskBrush", Description = "Paints a SpriteVisual with a CompositionBrush with an opacity mask applied to it.", IsManualTest = true)]
