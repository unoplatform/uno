...
[Sample("Windows.Devices", Name = "ProximitySensor", Description = "Demonstrates use of Windows.Devices.Sensors.ProximitySensor", ViewModelType = typeof(ProximitySensorTestsViewModel), IgnoreInSnapshotTests = true)]
