...
namespace UITests.Shared.Windows_System
{
    ...
    public sealed partial class MemoryManagerTests : Page
    {
		...
		{
			ValueMemoryManager.Text = "AppMemoryUsage: " + Windows.System.MemoryManager.AppMemoryUsage.ToString() + " and AppMemoryUsageLimit: " + Windows.System.MemoryManager.AppMemoryUsageLimit.ToString();
		}
	}
}
