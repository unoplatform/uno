...
{
	[SampleControlInfo("WebView", "WebView2_Static", typeof(WebView2StaticViewModel), description: "Simple WebView2 navigation using Source property", IgnoreInSnapshotTests = true)]
