...
{
	[Uno.UI.Samples.Controls.SampleControlInfo("WebView", "WebView2_NavigateToString2", description: "Testing a NavigateToString with a very long string", IgnoreInSnapshotTests = true)]
