...
{
	[SampleControlInfo("WebView", "WebView2_NavigateToString", typeof(WebView2ViewModel), description: "WebView2 demonstrating NavigateToString method", IgnoreInSnapshotTests = true)]
