...
public sealed class WebGpuDrawingFactory : IDrawingFactory
{
	...
	public IEffectFilter CreateEffectFilter(Windows.Graphics.Effects.IGraphicsEffect effect, Windows.Foundation.Rect bounds, Func<string, Uno.UI.Composition.Drawing.IEffectSource> sourceResolver, bool useBackdropBlurClamp, out bool hasBackdropInput)
	{
