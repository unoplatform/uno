...
namespace Uno.WinAppSDKSyncGenerator
{
	abstract class Generator
	{
		...
		public virtual async Task Build()
		{
			...
			_iOSCompilation = await LoadProject($@"{topProject}.netcoremobile.csproj", "net10.0-ios18.0");
			_tvOSCompilation = await LoadProject($@"{topProject}.netcoremobile.csproj", "net10.0-tvos18.0");
