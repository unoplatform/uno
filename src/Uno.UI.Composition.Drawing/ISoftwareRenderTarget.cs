...
/// <see cref="IGraphicsContext"/> hands over: the backend wraps <see cref="Pixels"/> / <see cref="RowBytes"/>
/// into its own surface. The buffer is owned by the context (valid until the next acquire/present cycle).
/// </summary>
