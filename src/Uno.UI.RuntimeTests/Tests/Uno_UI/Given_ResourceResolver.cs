...
public class Given_ResourceResolver
{
	...
	[TestMethod]
	[RunsOnUIThread]
	public async Task When_Resolving_FrameworkElement_Local_ThemeResource__AsdAsd()
	{
...
public partial class TestControl : Control, ITestable
{
	...
	{
		var msg = $"@xy {dependencyObject?.GetType().Name}.OnTextChanged: []{args.OldValue} -> []{args.NewValue}";
	}
}
