...
#else
			Assert.IsLessThanOrEqual(1, Math.Abs(11 - SUT.DesiredSize.Width), $"Actual size: {SUT.DesiredSize}");
			Assert.IsLessThanOrEqual(1, Math.Abs(50 - SUT.DesiredSize.Height), $"Actual size: {SUT.DesiredSize}");
#endif
		}
