...
namespace Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml
{
	...
	public partial class Given_UIElement
	{
		...
		public async Task When_Translation_On_Load()
		{
			...
			ImageAssert.DoesNotHaveColorAt(bitmap, new Windows.Foundation.Point(50, 50), Windows.UI.Colors.Blue);
			ImageAssert.HasColorAt(bitmap, new Windows.Foundation.Point(150, 150), Windows.UI.Colors.Blue);
		}
		...
		public async Task When_CanDrag_Child_And_Parent(bool childCanDrag)
		{
			...
			{
				Background = new SolidColorBrush(Windows.UI.Colors.LightCoral),
				Width = 400,
				Height = 300,
				CanDrag = true,
				Content = child
