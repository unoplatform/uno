...
//		[DataRow(typeof(Microsoft.UI.Xaml.Controls.Primitives.NavigationViewItemPresenter), 15)]
		[DataRow(typeof(Microsoft.UI.Xaml.Controls.NavigationViewItemHeader), 15)]
		[DataRow(typeof(Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator), 15)]
//#if false // Disabled for #10309
		[DataRow(typeof(Microsoft.UI.Xaml.Controls.NavigationView), 1)]
//#endif
...
#if NET5_0_OR_GREATER || __IOS__ || __ANDROID__
			if (activeControls != 0)
			{
