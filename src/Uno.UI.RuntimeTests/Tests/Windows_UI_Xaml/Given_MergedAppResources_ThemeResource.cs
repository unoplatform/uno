...
public class Given_MergedAppResources_ThemeResource
{
	...
	// The view must go before its dictionaries do: a later app theme change re-resolving a removed
	// {ThemeResource} crashes the whole native WinUI process.
	private static async Task UnloadViewAsync()
	{
