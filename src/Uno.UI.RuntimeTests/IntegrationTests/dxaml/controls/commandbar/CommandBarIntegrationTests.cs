...
namespace Windows.UI.Tests.Enterprise
{
	...
	public class CommandBarIntegrationTests : BaseDxamlTestClass
	{
		...
		[TestMethod]
		[PlatformCondition(ConditionMode.Exclude, RuntimeTestPlatforms.NativeIOS | RuntimeTestPlatforms.SkiaIOS | RuntimeTestPlatforms.NativeWasm)] // Flaky on iOS native, iOS Skia, and WASM native https://github.com/unoplatform/uno/issues/9080
