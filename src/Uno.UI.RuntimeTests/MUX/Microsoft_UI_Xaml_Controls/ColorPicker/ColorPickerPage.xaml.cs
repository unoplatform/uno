...
namespace MUXControlsTestApp
{
	public sealed partial class ColorPickerPage : TestPage
	{
		...
		public ColorPickerPage()
		{
			...
			this.ColorPicker.Color = Windows.UI.Colors.Red;
		...
		{
			this.ColorPicker.Color = Windows.UI.Colors.White;
		}
		...
		{
			this.ColorPicker.Color = Windows.UI.Colors.Green;
		}

		private void ColorBlueButton_Click(object sender, RoutedEventArgs e)
		{
			this.ColorPicker.Color = Windows.UI.Colors.Blue;
		}
		...
		{
			this.ColorPicker.PreviousColor = Windows.UI.Colors.Red;
		}

		private void PreviousColorGreenButton_Click(object sender, RoutedEventArgs e)
		{
			this.ColorPicker.PreviousColor = Windows.UI.Colors.Green;
		}

		private void PreviousColorBlueButton_Click(object sender, RoutedEventArgs e)
		{
			this.ColorPicker.PreviousColor = Windows.UI.Colors.Blue;
		}
