	...
	IGraphicsProvider<IGraphicsContext>
{
	...
	public SkiaGraphicsProvider(params GraphicsContextKind[] preferred)
	{
		_preferred = preferred.Length > 0
			? preferred
			: new[] { GraphicsContextKind.Vulkan, GraphicsContextKind.OpenGL, GraphicsContextKind.OpenGLES, GraphicsContextKind.WebGL, GraphicsContextKind.Metal, GraphicsContextKind.Software };
	}
