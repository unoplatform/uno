...
/// <summary>SkiaSharp implementation of the <see cref="IImageEncoderExtension"/> seam (resolved by BitmapEncoder).</summary>
internal sealed class SkiaImageEncoderExtension : IImageEncoderExtension
{
