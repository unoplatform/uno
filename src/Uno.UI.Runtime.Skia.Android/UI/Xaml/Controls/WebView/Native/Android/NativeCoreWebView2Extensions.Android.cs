...
{
	public static NativeCoreWebView2WebResourceRequestedEventArgs ToAndroid(this CoreWebView2WebResourceRequestedEventArgs args)
		=> args.NativeArgs is NativeCoreWebView2WebResourceRequestedEventArgs nativeArgs
			? nativeArgs
			: throw new InvalidOperationException("The provided CoreWebView2WebResourceRequestedEventArgs is not backed by an Android native implementation.");

	public static NativeCoreWebView2WebResourceResponse ToAndroid(this CoreWebView2WebResourceResponse args)
		=> args.NativeResponse is NativeCoreWebView2WebResourceResponse nativeResponse
			? nativeResponse
			: throw new InvalidOperationException("The provided CoreWebView2WebResourceResponse is not backed by an Android native implementation.");

	public static NativeCoreWebView2WebResourceRequest ToAndroid(this CoreWebView2WebResourceRequest request)
