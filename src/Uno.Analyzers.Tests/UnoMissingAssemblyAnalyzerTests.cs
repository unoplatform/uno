...
public class UnoMissingAssemblyAnalyzerTests
{
	...
	[TestMethod]
	public async Task UseProgressRingWithoutLottiePackage_NoDiagnostic()
	{
		// ProgressRing renders via generated Composition visuals and no longer needs Uno.WinUI.Lottie.
		var code = """
			using Microsoft.UI.Xaml.Controls;
			public class C
			{
