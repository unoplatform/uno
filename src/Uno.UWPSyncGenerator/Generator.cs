							...
							using (b.BlockInvariant($"public {staticQualifier} {MapUWPTypes(SanitizeType(property.Type))} {property.Name}"))
							{
								...
								if (property.SetMethod != null)
								{
									using (b.BlockInvariant($"set"))
									{
										...
										// HACK: For unknown reason, this.SetValue(IsDefaultShadowEnabledProperty, value) doesn't resolve to the bool
										// overload generated by DependencyObjectGenerator.
										if (property.ContainingType.Name == "TimePickerFlyoutPresenter" && property.Type.SpecialType is SpecialType.System_Int32 or SpecialType.System_Double or SpecialType.System_Boolean)
										{
											valueArgument = "global::Uno.UI.Helpers.Boxes.Box(value)";
										}
										else
										{
											valueArgument = "value";
										...
										b.AppendLineInvariant($"this.SetValue({property.Name}Property, {valueArgument});");
									}
								}
							}
						}
