...
namespace System.Runtime.Serialization.Json
{
    internal class JavaScriptReader
    {
        ...
        private object ReadCore()
        {
            ...
            switch (c)
            {
                ...
                default:
                    ...
                    throw JsonError("ArgumentException_UnexpectedCharacter");
            }
        }
        ...
        private void Expect(char expected)
        {
            ...
            {
                throw JsonError("ArgumentException_ExpectedXButGotY");
            }
        }
        ...
        private void Expect(string expected)
        {
            for (int i = 0; i < expected.Length; i++)
            {
                ...
                {
                    throw JsonError("ArgumentException_ExpectedXDiferedAtY");
                }
            }
        }
