	...
	internal partial class XamlCodeGeneration
	{
		...
		public List<KeyValuePair<string, SourceText>> Generate()
		{
			...
			try
			{
				...
				GenerateCodeBehindForMissingClasses(xamlFiles, xamlTypeToXamlTypeBaseMap, outputFiles, ct);
		...
		private void GenerateCodeBehindForMissingClasses(
			...
			ConcurrentDictionary<INamedTypeSymbol, XamlRedirection.XamlType> xamlTypeToXamlTypeBaseMap,
			...
			CancellationToken ct)
		{
			foreach (var file in xamlFiles)
			{
				...
				var baseTypeSymbol = ResolveXamlRootElementType(topLevelControl.Type, file);
		...
		/// </summary>
		private INamedTypeSymbol? ResolveXamlRootElementType(XamlRedirection.XamlType xamlType, XamlFileDefinition file)
		{
