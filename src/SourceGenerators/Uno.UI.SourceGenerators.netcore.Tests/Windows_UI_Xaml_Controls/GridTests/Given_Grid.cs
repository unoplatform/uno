...
public class Given_Grid
{
	...
	public async Task When_Grid_Uses_Both_Syntaxes()
	{
		var test = new TestSetup(xamlFileName: "Grid_Uses_Both_Syntaxes.xaml", subFolder: Path.Combine("SourceGenerators", "Uno.UI.SourceGenerators.netcore.Tests", "Windows_UI_Xaml_Controls", "GridTests", "Controls"))
		{
			...
			DiagnosticResult.CompilerError("CS1912").WithSpan(@"Uno.UI.SourceGenerators\Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator\Grid_Uses_Both_Syntaxes_60238ec063a1a4c50b071fb0a12b10cb.cs", 110, 5, 110, 22).WithArguments("ColumnDefinitions"),
			...
			DiagnosticResult.CompilerError("CS1912").WithSpan(@"Uno.UI.SourceGenerators\Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator\Grid_Uses_Both_Syntaxes_60238ec063a1a4c50b071fb0a12b10cb.cs", 144, 5, 144, 19).WithArguments("RowDefinitions"),
			},
		};
