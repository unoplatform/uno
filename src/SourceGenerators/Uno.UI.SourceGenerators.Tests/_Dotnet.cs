...
internal record class _Dotnet(string Moniker, ReferenceAssemblies ReferenceAssemblies)
{
	...
	public static _Dotnet Previous = new("net9.0", ReferenceAssemblies.Net.Net90);

	public static _Dotnet Current = new("net10.0", ReferenceAssemblies.Net.Net100);

	public static _Dotnet CurrentAndroid = new("net10.0-android", ReferenceAssemblies.Net.Net100Android);
}
