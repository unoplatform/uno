...
internal record class _Dotnet(string Moniker, ReferenceAssemblies ReferenceAssemblies)
{
	...
	public static _Dotnet Previous = new("net10.0", ReferenceAssemblies.Net.Net80);

	public static _Dotnet Current = new("net11.0", ReferenceAssemblies.Net.Net90);

	public static _Dotnet CurrentAndroid = new("net11.0-android", ReferenceAssemblies.Net.Net90Android);
}
