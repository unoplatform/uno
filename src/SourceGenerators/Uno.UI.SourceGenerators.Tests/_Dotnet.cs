...
internal record class _Dotnet(string Moniker, ReferenceAssemblies ReferenceAssemblies)
{
	...
	public static _Dotnet Current = new("net11.0", ReferenceAssemblies.Net.Net100); // JONP-TODO

	public static _Dotnet CurrentAndroid = new("net11.0-android", ReferenceAssemblies.Net.Net100Android); // JONP-TODO
}
