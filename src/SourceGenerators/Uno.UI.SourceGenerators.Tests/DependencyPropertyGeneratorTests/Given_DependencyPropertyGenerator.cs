...
public class Given_DependencyPropertyGenerator
{
	...
	public async Task TestGetDefaultValuePresentWithDefaultValueArgument()
	{
		...
		test.ExpectedDiagnostics.Add(
			...
			DiagnosticResult.CompilerError("CS1029").WithSpan(Path.Combine("Uno.UI.SourceGenerators.Internal", "Uno.UI.SourceGenerators.DependencyObject.DependencyPropertyGenerator", "Mynamespace.C.cs"), 56, 10, 56, 117).WithArguments("The generated property MyValue cannot contains both a DefaultValue and the GetMyValueDefaultValue() method.")
		);
	...
	[TestMethod]
	public async Task TestBoxedValuesWhenBoxesIsAccessible()
	{
		var test = new Verify.Test
		{
			IgnoreAccessibility = true,
						...
						namespace Mynamespace
						{
							partial class C
							{
								...
								private bool GetMyValueValue()
								{
									if (!_MyValuePropertyBackingFieldSet)
									{
										_MyValuePropertyBackingField = (bool)GetValue(MyValueProperty);
										_MyValuePropertyBackingFieldSet = true;
									}
									return _MyValuePropertyBackingField;
								}
								...
								private bool _MyValuePropertyBackingField
								{
									get => (_generatedDependencyPropertyFlags0 & GeneratedDependencyPropertyFlags0.DPFlag1) != 0;
									set { if (value) _generatedDependencyPropertyFlags0 |= GeneratedDependencyPropertyFlags0.DPFlag1; else _generatedDependencyPropertyFlags0 &= ~GeneratedDependencyPropertyFlags0.DPFlag1; }
								}
								/// <summary>
								/// Generated method used to create the <see cref="MyValueProperty" /> member value
								/// </summary>
								...
								DependencyProperty.Register(
									...
									ownerType: typeof(global::Mynamespace.C),
									typeMetadata: new global::Microsoft.UI.Xaml.FrameworkPropertyMetadata(
										defaultValue: global::Uno.UI.Helpers.Boxes.BooleanBoxes.BoxedTrue /* GetMyValueDefaultValue(), global::Mynamespace.C */
										, backingFieldUpdateCallback: OnMyValueBackingFieldUpdate
								));
								private static void OnMyValueBackingFieldUpdate(object instance, object newValue)
								{
									var typedInstance = instance as global::Mynamespace.C;
									typedInstance._MyValuePropertyBackingField = (bool)newValue;
									typedInstance._MyValuePropertyBackingFieldSet = true;
								}
								#endregion
							}
	...
	[TestMethod]
	public async Task TestNegativeZeroDoubleDefaultValueKeepsItsSign()
	{
		var test = new Verify.Test
		{
			IgnoreAccessibility = true,
						...
						namespace Mynamespace
						{
							partial class C
							{
								...
								private double GetMyValueValue()
								{
									if (!_MyValuePropertyBackingFieldSet)
									{
										_MyValuePropertyBackingField = (double)GetValue(MyValueProperty);
										_MyValuePropertyBackingFieldSet = true;
									}
									return _MyValuePropertyBackingField;
								}
								...
								private double _MyValuePropertyBackingField;
								/// <summary>
								/// Generated method used to create the <see cref="MyValueProperty" /> member value
								/// </summary>
								private static global::Microsoft.UI.Xaml.DependencyProperty CreateMyValueProperty() => 
								DependencyProperty.Register(
									...
									ownerType: typeof(global::Mynamespace.C),
									typeMetadata: new global::Microsoft.UI.Xaml.FrameworkPropertyMetadata(
										defaultValue: (double)-0d /* GetMyValueDefaultValue(), global::Mynamespace.C */
										, backingFieldUpdateCallback: OnMyValueBackingFieldUpdate
								));
								private static void OnMyValueBackingFieldUpdate(object instance, object newValue)
								{
									var typedInstance = instance as global::Mynamespace.C;
									typedInstance._MyValuePropertyBackingField = (double)newValue;
									typedInstance._MyValuePropertyBackingFieldSet = true;
								}
								#endregion
							}
