    ...
    public async Task TestNested()
    {
	 ...
	 partial class OuterClass
	 {
	 	...
	 	partial class Inner : IDependencyObjectStoreProvider, IWeakReferenceProvider
	 	{
	 		...
	 		public override string ToString() => GetType().FullName;		// hasOverridesAttachedToWindowiOS=false
	 		...
	 		public static DependencyProperty TemplatedParentProperty { get ; } =
	 			DependencyProperty.Register(
	 				...
	 				typeMetadata: new FrameworkPropertyMetadata(
	 					defaultValue: null,
	 					options: FrameworkPropertyMetadataOptions.ValueDoesNotInheritDataContext | FrameworkPropertyMetadataOptions.WeakStorage,
