...
namespace TestRepro
{
	partial class MainPage : global::Microsoft.UI.Xaml.Controls.Page
	{
		...
		private void InitializeComponent()
		{
			...
			var __that = this;
			base.IsParsing = true;
			// Source 0\MainPage.xaml (Line 1:3)
			;
			...
			// [WARNING] C:/Project/0/MainPage.xaml(1,3): Property 'base' does not exist on 'Page', this error was however considered irrelevant by the XamlFileGenerator.
			}
			))
			.MainPage_d6cd66944958ced0c513e0a04797b51d_XamlApply((MainPage_d6cd66944958ced0c513e0a04797b51dXamlApplyExtensions.XamlApplyHandler0)(__p1 => 
			{
