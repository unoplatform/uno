...
namespace TestRepro
{
	partial class MainPage : global::Microsoft.UI.Xaml.Controls.Page
	{
						...
						global::MyProject.GlobalStaticResources.__PreserveProperties(
							...
							__p1.SetBinding(
								...
								new Microsoft.UI.Xaml.Data.Binding()
								{
									...
									.BindingApply(__that, (___b, ___t) =>  /*defaultBindModeOneTime ViewModel.P*/ global::Uno.UI.Xaml.BindingHelper.SetBindingXBindProvider(___b, ___t, ___ctx => ___ctx is global::TestRepro.MainPage ___tctx ? (TryGetInstance_xBind_1(___tctx, out var bindResult1) ? (true, bindResult1) : (false, default)) : (false, default), (___ctx, __value) => { if(___ctx is global::TestRepro.MainPage ___tctx) TrySetInstance_xBind_1(___tctx, __value); } , new [] {"ViewModel.P"}, new global::System.Func<object, object>[][] { new global::System.Func<object, object>[] { static (object o) => ((global::TestRepro.MainPage)o).ViewModel, static (object o) => ((global::TestRepro.VM)o).P } }))
							);
		...
		private static bool TrySetInstance_xBind_1(global::TestRepro.MainPage ___tctx, object __value)
		{
			var sub1 = ___tctx.ViewModel;
			if (sub1 == null) return false;
			sub1.P = (string)global::Microsoft.UI.Xaml.Markup.XamlBindingHelper.ConvertValue(typeof(string), __value);
			return true;
		}
	}
}
