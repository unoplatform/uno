						...
						global::MyProject.GlobalStaticResources.__PreserveProperties(
							...
							__p1.SetBinding(
								...
								new Microsoft.UI.Xaml.Data.Binding()
								{
									...
									.BindingApply(__that, (___b, ___t) =>  /*defaultBindModeOneTime ViewModel.IsEnabled*/ global::Uno.UI.Xaml.BindingHelper.SetBindingXBindProvider(___b, ___t, ___ctx => ___ctx is global::TestRepro.MainPage ___tctx ? ((true, ___tctx.ViewModel.IsEnabled)) : (false, default), (___ctx, __value) => { if(___ctx is global::TestRepro.MainPage ___tctx) ___tctx.ViewModel.IsEnabled = (bool)global::Microsoft.UI.Xaml.Markup.XamlBindingHelper.ConvertValue(typeof(bool), __value); } , new [] {"ViewModel.IsEnabled"}, new global::System.Func<object, object>[][] { new global::System.Func<object, object>[] { static (object o) => ((global::TestRepro.MainPage)o).ViewModel, static (object o) => ((global::TestRepro.MyViewModel)o).IsEnabled } }))
							);
