...
public partial class Given_Parser
{
	...
	public async Task When_DuplicateProperty_AttributeAndImplicitContent()
	{
		...
		test.ExpectedDiagnostics.Add(
			DiagnosticResult.CompilerError("XLS0501").WithSpan("//Project/0/MainPage.xaml", 5, 4, 5, 4).WithArguments("The property 'Content' is set more than once"));
	...
	public async Task When_DuplicateProperty_AttributeAndPropertyElement()
	{
		...
		test.ExpectedDiagnostics.Add(
			DiagnosticResult.CompilerError("XLS0501").WithSpan("//Project/0/MainPage.xaml", 5, 27, 5, 27).WithArguments("The property 'Content' is set more than once"));
	...
	public async Task When_DuplicateProperty_TwoPropertyElements()
	{
		...
		test.ExpectedDiagnostics.Add(
			DiagnosticResult.CompilerError("XLS0501").WithSpan("//Project/0/MainPage.xaml", 8, 27, 8, 27).WithArguments("The property 'Content' is set more than once"));
	...
	public async Task When_DuplicateProperty_NonContentProperty_AttributeAndPropertyElement()
	{
		...
		test.ExpectedDiagnostics.Add(
			DiagnosticResult.CompilerError("XLS0501").WithSpan("//Project/0/MainPage.xaml", 5, 19, 5, 19).WithArguments("The property 'Text' is set more than once"));
	...
	public async Task When_DuplicateProperty_DatePickerHeaderAttributeAndImplicitContent()
	{
		...
		test.ExpectedDiagnostics.Add(
			DiagnosticResult.CompilerError("XLS0501").WithSpan("//Project/0/MainPage.xaml", 4, 28, 4, 28).WithArguments("The property 'Header' is set more than once"));
	...
	public async Task When_DuplicateProperty_NonContentProperty_TwoPropertyElements()
	{
		...
		test.ExpectedDiagnostics.Add(
			DiagnosticResult.CompilerError("XLS0501").WithSpan("//Project/0/MainPage.xaml", 6, 19, 6, 19).WithArguments("The property 'Text' is set more than once"));
