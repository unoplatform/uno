...
public class Given_MvvmGeneratedMembers
{
	...
	public async Task When_ObservableProperty_AttributeDoesNotExists()
	{
		...
		{
			// Uno.UI.SourceGenerators\Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator\MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs(76,254): error CS1061: 'MyViewModel' does not contain a definition for 'Name' and no accessible extension method 'Name' accepting a first argument of type 'MyViewModel' could be found (are you missing a using directive or an assembly reference?)
			DiagnosticResult.CompilerError("CS1061").WithSpan(Path.Combine("Uno.UI.SourceGenerators", "Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator", "MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs"), 76, 254, 76, 258).WithArguments("TestRepro.MyViewModel", "Name"),
			// Uno.UI.SourceGenerators\Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator\MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs(100,254): error CS1061: 'MyViewModel' does not contain a definition for 'Name' and no accessible extension method 'Name' accepting a first argument of type 'MyViewModel' could be found (are you missing a using directive or an assembly reference?)
			DiagnosticResult.CompilerError("CS1061").WithSpan(Path.Combine("Uno.UI.SourceGenerators", "Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator", "MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs"), 100, 254, 100, 258).WithArguments("TestRepro.MyViewModel", "Name"),
			// Uno.UI.SourceGenerators\Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator\MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs(124,252): error CS1061: 'MyViewModel' does not contain a definition for 'Name' and no accessible extension method 'Name' accepting a first argument of type 'MyViewModel' could be found (are you missing a using directive or an assembly reference?)
			DiagnosticResult.CompilerError("CS1061").WithSpan(Path.Combine("Uno.UI.SourceGenerators", "Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator", "MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs"), 124, 254, 124, 258).WithArguments("TestRepro.MyViewModel", "Name"),
		});
