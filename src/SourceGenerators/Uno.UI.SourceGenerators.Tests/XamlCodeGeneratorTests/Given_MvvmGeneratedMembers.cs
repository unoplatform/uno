...
public class Given_MvvmGeneratedMembers
{
	...
	public async Task When_ObservableProperty_AttributeDoesNotExists()
	{
		...
		test.ExpectedDiagnostics.AddRange(new[]
		{
			...
			// Uno.UI.SourceGenerators\Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator\MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs(116,254): error CS1061: 'MyViewModel' does not contain a definition for 'Name' and no accessible extension method 'Name' accepting a first argument of type 'MyViewModel' could be found (are you missing a using directive or an assembly reference?)
