...
public class Given_MvvmGeneratedMembers
{
	...
	public async Task When_ObservableProperty_AttributeDoesNotExists()
	{
		...
		test.ExpectedDiagnostics.AddRange(new[]
		{
			...
			DiagnosticResult.CompilerError("CS1061").WithSpan(Path.Join("Uno.UI.SourceGenerators", "Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator", "MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs"), 68, 254, 68, 258).WithArguments("TestRepro.MyViewModel", "Name"),
			...
			DiagnosticResult.CompilerError("CS1061").WithSpan(Path.Join("Uno.UI.SourceGenerators", "Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator", "MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs"), 92, 254, 92, 258).WithArguments("TestRepro.MyViewModel", "Name"),
			...
			DiagnosticResult.CompilerError("CS1061").WithSpan(Path.Join("Uno.UI.SourceGenerators", "Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator", "MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs"), 116, 254, 116, 258).WithArguments("TestRepro.MyViewModel", "Name"),
		});
