	...
	public async Task When_Ambiguous_Type_In_Global_Namespaces()
	{
		...
		[
			...
			DiagnosticResult.CompilerError("CS0246")
				...
				.WithSpan(Path.Join("Uno.UI.SourceGenerators", "Uno.UI.SourceGenerators.XamlGenerator.XamlCodeGenerator", "MainPage_0e3f323f9a22a3699cbcd4f0217eee4a.cs"), 47, 9, 47, 22)
