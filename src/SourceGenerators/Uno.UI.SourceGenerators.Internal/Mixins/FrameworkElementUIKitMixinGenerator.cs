...
public sealed class FrameworkElementUIKitMixinGenerator : IIncrementalGenerator
{
	private static readonly DiagnosticDescriptor MissingEffectiveViewportTemplate = new(
		...
		"The FrameworkElement.EffectiveViewport.cs AdditionalFile is missing or unreadable. EffectiveViewport partials will not be generated for UIKit.",
	...
	public void Initialize(IncrementalGeneratorInitializationContext context)
	{
		...
		// and DependencyPropertyGenerator. Platform filtering via #if UNO_MIXIN_GENERATION && __APPLE_UIKIT__.
