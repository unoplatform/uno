...
namespace Windows.Foundation.Collections
{
	...
	public  partial class ValueSet : global::Windows.Foundation.Collections.IPropertySet,global::Windows.Foundation.Collections.IObservableMap<string, object>,global::System.Collections.Generic.IDictionary<string, object>,global::System.Collections.Generic.IEnumerable<global::System.Collections.Generic.KeyValuePair<string, object>>
	{
		...
		public  uint Size
		{
			get
			{
				throw new global::System.NotImplementedException("The member uint ValueSet.Size is not implemented in Uno.");
			}
		}
		#endif
		#if false || false || NET461 || false || false
		...
		public ValueSet() 
		{
			global::Windows.Foundation.Metadata.ApiInformation.TryRaiseNotImplemented("Windows.Foundation.Collections.ValueSet", "ValueSet.ValueSet()");
		}
		#endif
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.ValueSet()
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.MapChanged.add
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.MapChanged.remove
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.Lookup(string)
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.Size.get
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.HasKey(string)
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.GetView()
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.Insert(string, object)
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.Remove(string)
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.Clear()
		// Forced skipping of method Windows.Foundation.Collections.ValueSet.First()
		#if __ANDROID__ || __IOS__ || NET461 || __WASM__ || __MACOS__
		[global::Uno.NotImplemented]
		public  event global::Windows.Foundation.Collections.MapChangedEventHandler<string, object> MapChanged
		{
			...
			add
			{
				global::Windows.Foundation.Metadata.ApiInformation.TryRaiseNotImplemented("Windows.Foundation.Collections.ValueSet", "event MapChangedEventHandler<string, object> ValueSet.MapChanged");
			}
			[global::Uno.NotImplemented]
			remove
			{
