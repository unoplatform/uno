...
namespace Windows.Foundation.Metadata
{
	...
	{
		// Skipping already declared method Windows.Foundation.Metadata.ContractVersionAttribute.ContractVersionAttribute(uint)
		// Forced skipping of method Windows.Foundation.Metadata.ContractVersionAttribute.ContractVersionAttribute(uint)
		// Skipping already declared method Windows.Foundation.Metadata.ContractVersionAttribute.ContractVersionAttribute(System.Type, uint)
		// Forced skipping of method Windows.Foundation.Metadata.ContractVersionAttribute.ContractVersionAttribute(System.Type, uint)
		// Skipping already declared method Windows.Foundation.Metadata.ContractVersionAttribute.ContractVersionAttribute(string, uint)
