...
namespace Windows.Foundation.Metadata
{
	...
	{
		// Skipping already declared method Windows.Foundation.Metadata.PreviousContractVersionAttribute.PreviousContractVersionAttribute(string, uint, uint, string)
		...
		// Skipping already declared method Windows.Foundation.Metadata.PreviousContractVersionAttribute.PreviousContractVersionAttribute(string, uint, uint)
