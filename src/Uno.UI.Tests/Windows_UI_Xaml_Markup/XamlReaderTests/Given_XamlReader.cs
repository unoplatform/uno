...
namespace Uno.UI.Tests.Windows_UI_Xaml_Markup.XamlReaderTests
{
	...
	public class Given_XamlReader : Context
	{
		...
		public void When_Setter_Override_From_Visual_Parent()
		{
			...
			Assert.AreEqual(Windows.UI.Colors.Red, ((SolidColorBrush)tb.Foreground).Color);
		}
		...
		public void When_Setter_Override_State_From_Visual_Parent()
		{
			...
			Assert.IsNotNull(tb);
			Assert.IsInstanceOfType(tb.Foreground, typeof(SolidColorBrush));
			Assert.AreEqual(Windows.UI.Colors.Orange, ((SolidColorBrush)tb.Foreground).Color);
		}
		...
		public void When_ThemeResource_Inherited_multiple()
		{
			...
			Assert.AreEqual(Windows.UI.Colors.Red, ((SolidColorBrush)border1.Background).Color);
			Assert.AreEqual(Windows.UI.Colors.Pink, ((SolidColorBrush)border1.BorderBrush).Color);
			Assert.AreEqual(Windows.UI.Colors.Blue, ((SolidColorBrush)border2.Background).Color);
			Assert.AreEqual(Windows.UI.Colors.Yellow, ((SolidColorBrush)border2.BorderBrush).Color);
		}
