...
{
	internal delegate void DispatchedHandler();
	internal delegate void CancellableDispatchedHandler(CancellationToken ct);
	internal delegate void IdleDispatchedHandler(IdleDispatchedHandlerArgs e);
