...
namespace Uno.UI.Tests
{
	...
	public partial class Given_DependencyObject
	{
		...
		public void When_AreDifferent()
		{
			...
			Assert.IsFalse(DependencyObject.AreDifferent(null, null));
			Assert.IsFalse(DependencyObject.AreDifferent(0, 0));
			Assert.IsFalse(DependencyObject.AreDifferent(0.0, 0.0));
			Assert.IsFalse(DependencyObject.AreDifferent(o1, o1));
			Assert.IsFalse(DependencyObject.AreDifferent(o2, o2));
			Assert.IsFalse(DependencyObject.AreDifferent(s1, s2));
			Assert.IsFalse(DependencyObject.AreDifferent(1.ToString(), 1.ToString()));
			Assert.IsFalse(DependencyObject.AreDifferent("", ""));
			Assert.IsFalse(DependencyObject.AreDifferent("1", "1"));

			Assert.IsTrue(DependencyObject.AreDifferent(0, null));
			Assert.IsTrue(DependencyObject.AreDifferent(null, 0));
			Assert.IsTrue(DependencyObject.AreDifferent(1, 0));
			Assert.IsTrue(DependencyObject.AreDifferent(0, 0.0));
			Assert.IsTrue(DependencyObject.AreDifferent(Visibility.Collapsed, null));
			Assert.IsTrue(DependencyObject.AreDifferent(null, Visibility.Collapsed));
			Assert.IsTrue(DependencyObject.AreDifferent(Visibility.Collapsed, Visibility.Visible));
			Assert.IsTrue(DependencyObject.AreDifferent(Visibility.Visible, Visibility.Collapsed));

			Assert.IsTrue(DependencyObject.AreDifferent(o1, null));
			Assert.IsTrue(DependencyObject.AreDifferent(null, o1));
			Assert.IsTrue(DependencyObject.AreDifferent(o1, o2));

			Assert.IsTrue(DependencyObject.AreDifferent("", null));
			Assert.IsTrue(DependencyObject.AreDifferent("", "1"));
			Assert.IsTrue(DependencyObject.AreDifferent(null, "1"));
			Assert.IsTrue(DependencyObject.AreDifferent("1", "2"));

			var mo1a = new MyObject(1);
			var mo1b = new MyObject(1);
			var mo2 = new MyObject(2);
			Assert.IsFalse(DependencyObject.AreDifferent(mo1a, mo1a));

			Assert.IsTrue(DependencyObject.AreDifferent(mo1a, mo1b));
			Assert.IsTrue(DependencyObject.AreDifferent(mo1b, mo1a));
			Assert.IsTrue(DependencyObject.AreDifferent(mo1a, mo2));
			Assert.IsTrue(DependencyObject.AreDifferent(mo1b, mo2));
		}
