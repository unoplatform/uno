...
#endif
	// Uno: derives from Panel (not FrameworkElement as in the WinUI IDL) so FallbackContent can be
	// hosted as a child, matching WinUI's internal Panel-derived implementation. Panel is a
	// FrameworkElement, so this stays source-compatible.
	public partial class AnimatedVisualPlayer : global::Microsoft.UI.Xaml.Controls.Panel
	{
