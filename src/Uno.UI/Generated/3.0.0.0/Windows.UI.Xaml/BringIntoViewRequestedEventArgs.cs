...
namespace Windows.UI.Xaml
{
	...
	public  partial class BringIntoViewRequestedEventArgs : global::Windows.UI.Xaml.RoutedEventArgs
	{
		...
		public  double VerticalOffset
		{
			get
			{
				throw new global::System.NotImplementedException("The member double BringIntoViewRequestedEventArgs.VerticalOffset is not implemented in Uno.");
			}
			set
			{
		...
		public  global::Windows.Foundation.Rect TargetRect
		{
			get
			{
				throw new global::System.NotImplementedException("The member Rect BringIntoViewRequestedEventArgs.TargetRect is not implemented in Uno.");
			}
			set
			{
		...
		public  global::Windows.UI.Xaml.UIElement TargetElement
		{
			get
			{
				throw new global::System.NotImplementedException("The member UIElement BringIntoViewRequestedEventArgs.TargetElement is not implemented in Uno.");
			}
			set
			{
		...
		public  double HorizontalOffset
		{
			get
			{
				throw new global::System.NotImplementedException("The member double BringIntoViewRequestedEventArgs.HorizontalOffset is not implemented in Uno.");
			}
			set
			{
		...
		public  bool Handled
		{
			get
			{
				throw new global::System.NotImplementedException("The member bool BringIntoViewRequestedEventArgs.Handled is not implemented in Uno.");
			}
			set
			{
		...
		public  bool AnimationDesired
		{
			get
			{
				throw new global::System.NotImplementedException("The member bool BringIntoViewRequestedEventArgs.AnimationDesired is not implemented in Uno.");
			}
			set
			{
		...
		public  double HorizontalAlignmentRatio
		{
			get
			{
				throw new global::System.NotImplementedException("The member double BringIntoViewRequestedEventArgs.HorizontalAlignmentRatio is not implemented in Uno.");
			}
		}
		#endif
		#if __ANDROID__ || __IOS__ || NET461 || __WASM__ || __MACOS__
		...
		public  double VerticalAlignmentRatio
		{
			get
			{
				throw new global::System.NotImplementedException("The member double BringIntoViewRequestedEventArgs.VerticalAlignmentRatio is not implemented in Uno.");
			}
		}
		#endif
