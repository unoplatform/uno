	...
	public static class FeatureConfiguration
	{
		...
		public static class Style
		{
			...
			public static void ConfigureNativeFrameNavigation()
			{
				...
				{
					SetUWPDefaultStylesOverride<Windows.UI.Xaml.Controls.Frame>(useUWPDefaultStyle: false);
				}
		...
		public static class Shape
		{
			...
			{
				get => Windows.UI.Xaml.Shapes.Shape.BBoxCacheSize;
				set => Windows.UI.Xaml.Shapes.Shape.BBoxCacheSize = value;
			}
#else
