...
internal static class Boxes
{
	...
	public static object Box(RoutedEventFlag value) => value switch
	{
		...
		RoutedEventFlag.PreviewKeyDown => RoutedEventFlagBoxes.PreviewKeyDown,
		RoutedEventFlag.KeyDown => RoutedEventFlagBoxes.KeyDown,
		RoutedEventFlag.PreviewKeyUp => RoutedEventFlagBoxes.PreviewKeyUp,
		RoutedEventFlag.KeyUp => RoutedEventFlagBoxes.KeyUp,
		RoutedEventFlag.CharacterReceived => RoutedEventFlagBoxes.CharacterReceived,
		...
		RoutedEventFlag.ContextRequested => RoutedEventFlagBoxes.ContextRequested,
		RoutedEventFlag.ContextCanceled => RoutedEventFlagBoxes.ContextCanceled,
		_ => value,
	};
}
