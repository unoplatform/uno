...
namespace Microsoft.UI.Xaml.Controls
{
	partial class UniformGridLayout : OrientationBasedMeasures
	{
		...
		private protected Rect MinorMajorRect(double minor, double major, double minorSize, double majorSize) => MinorMajorRect((float)minor, (float)major, (float)minorSize, (float)majorSize);
