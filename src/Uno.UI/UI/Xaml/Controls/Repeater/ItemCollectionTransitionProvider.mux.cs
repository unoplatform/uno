// MUX Reference ItemCollectionTransitionProvider.cpp, tag winui3/release/1.6-stable
...
partial class ItemCollectionTransitionProvider
{
	...
	public void QueueTransition(ItemCollectionTransition transition)
	{
		...
		// identified by the current _transitionsBatch value.
	...
	/// <summary>
	/// Determines whether a specific transition should be animated by calling the ShouldAnimateCore override.
	/// </summary>
