...
// MUX Reference ViewManager.cpp, commit 4b206bce3
...
partial class ViewManager
{
	...
	UIElement GetElementFromElementFactory(int index)
	{
		...
		// Clear before doing work to avoid stale state on early exits.
...
#if HAS_UNO  //TODO: Uno specific - remove when #4689 is fixed
	...
	{
		bool isInPinnedPool = virtInfo.IsInPinnedPool;
