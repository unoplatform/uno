...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class Layout : DependencyObject
	{
		...
		/// <summary>
		/// When overridden in a derived class, creates a default item transition provider for this layout.
		/// </summary>
		/// <returns>The default item transition provider for this layout, or <c>null</c> if none is provided.</returns>
