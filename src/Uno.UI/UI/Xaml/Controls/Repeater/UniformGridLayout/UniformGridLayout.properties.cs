...
namespace Microsoft.UI.Xaml.Controls
{
	partial class UniformGridLayout
	{
		...
		public static DependencyProperty MinColumnSpacingProperty { get; } = DependencyProperty.Register(
			"MinColumnSpacing", typeof(double), typeof(UniformGridLayout), new FrameworkPropertyMetadata(DoubleBoxes.Zero, propertyChangedCallback: (sender, args) => ((UniformGridLayout)sender).OnPropertyChanged(args)));
		...
		public static DependencyProperty MinItemHeightProperty { get; } = DependencyProperty.Register(
			"MinItemHeight", typeof(double), typeof(UniformGridLayout), new FrameworkPropertyMetadata(DoubleBoxes.Zero, propertyChangedCallback: (sender, args) => ((UniformGridLayout)sender).OnPropertyChanged(args)));

		public double MinItemHeight
		{
			get => (double)GetValue(MinItemHeightProperty);
			set => SetValue(MinItemHeightProperty, Boxer.Box(value));
		}

		public static DependencyProperty MinItemWidthProperty { get; } = DependencyProperty.Register(
			"MinItemWidth", typeof(double), typeof(UniformGridLayout), new FrameworkPropertyMetadata(DoubleBoxes.Zero, propertyChangedCallback: (sender, args) => ((UniformGridLayout)sender).OnPropertyChanged(args)));

		public double MinItemWidth
		{
			get => (double)GetValue(MinItemWidthProperty);
			set => SetValue(MinItemWidthProperty, Boxer.Box(value));
		}

		public static DependencyProperty MinRowSpacingProperty { get; } = DependencyProperty.Register(
			"MinRowSpacing", typeof(double), typeof(UniformGridLayout), new FrameworkPropertyMetadata(DoubleBoxes.Zero, propertyChangedCallback: (sender, args) => ((UniformGridLayout)sender).OnPropertyChanged(args)));
