...
namespace Microsoft.UI.Xaml.Controls.Primitives
{
	public sealed partial class CalendarViewTemplateSettings : DependencyObject
	{
		...
		public double MinViewWidth
		{
			...
			internal set => SetValue(MinViewWidthProperty, Boxer.Box(value));
		}
		...
		public double CenterX
		{
			...
			internal set => SetValue(CenterXProperty, Boxer.Box(value));
		}
		...
		public double CenterY
		{
			...
			internal set => SetValue(CenterYProperty, Boxer.Box(value));
		}
