	...
	internal abstract partial class CalendarViewGeneratorHost : DependencyObject
	{
		...
		internal int CalculateOffsetFromMinDate(DateTime date)
		{
			...
			while (true)
			{
				...
				{
					global::System.Diagnostics.Debug.WriteLine("CalendarViewGeneartorHost.CalculateOffsetFromMinDate[{0}]:  estimationCount = {1}.", this, Boxer.Box(estimationCount));
				...
				while (true)
				{
					...
					{
						global::System.Diagnostics.Debug.WriteLine("CalendarViewGeneartorHost.CalculateOffsetFromMinDate[{0}]: over boundary, retryCount = {1}.", this, Boxer.Box(retryCount));
						global::System.Diagnostics.Debug.Assert(false);
					}
#endif
