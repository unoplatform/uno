...
public enum FlyoutPlacementMode
{
	...
	/// of flyout aligned with left edge of the target element.
	/// </summary>
	TopEdgeAlignedLeft,

	/// <summary>
	/// Preferred location is above the target element, with the right edge
	/// of flyout aligned with right edge of the target element.
	/// </summary>
	TopEdgeAlignedRight,
	...
	/// <summary>
	/// Preferred location is to the left of the target element, with
	/// the top edge of flyout aligned with top edge of the target element.
	/// </summary>
	LeftEdgeAlignedTop,
	
	/// <summary>
	/// Preferred location is to the left of the target element, with
	/// the bottom edge of flyout aligned with bottom edge of the target element.
	/// </summary>
	LeftEdgeAlignedBottom,

	/// <summary>
	/// Preferred location is to the right of the target element, with
	/// the top edge of flyout aligned with top edge of the target element.
	/// </summary>
	RightEdgeAlignedTop,
