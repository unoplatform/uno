...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class Canvas : Panel
	{
		...
		public static double GetLeft(global::Microsoft.UI.Xaml.UIElement element) => GetLeft((DependencyObject)element);

		public static void SetLeft(global::Microsoft.UI.Xaml.UIElement element, double length) => SetLeft((DependencyObject)element, length);

		public static double GetTop(global::Microsoft.UI.Xaml.UIElement element) => GetTop((DependencyObject)element);

		public static void SetTop(global::Microsoft.UI.Xaml.UIElement element, double length) => SetTop((DependencyObject)element, length);

		public static int GetZIndex(global::Microsoft.UI.Xaml.UIElement element) => (int)GetZIndex((DependencyObject)element);

		public static void SetZIndex(global::Microsoft.UI.Xaml.UIElement element, int value) => SetZIndex((DependencyObject)element, value);
	}
}
