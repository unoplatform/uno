...
//#pragma endregion
    ...
    IInspectable LayoutState() const { return m_layoutState.get(); }
    void LayoutState(const IInspectable& value) { m_layoutState.set(value); }
    Rect VisibleWindow() const { return m_viewportManager.GetLayoutVisibleWindow(); }
    Rect RealizationWindow() const { return m_viewportManager.GetLayoutRealizationWindow(); }
    UIElement SuggestedAnchor() const { return m_viewportManager.SuggestedAnchor(); }
    UIElement MadeAnchor() const { return m_viewportManager.MadeAnchor(); }
    Point LayoutOrigin() const { return m_layoutOrigin; }
    void LayoutOrigin(Point value) { m_layoutOrigin = value; }
