...
public partial class TabViewItem
{
	...
	public static DependencyProperty IsClosableProperty { get; } =
		DependencyProperty.Register(nameof(IsClosable), typeof(bool), typeof(TabViewItem), new FrameworkPropertyMetadata(Boxes.BoolBoxes.True, OnIsClosablePropertyChanged));
