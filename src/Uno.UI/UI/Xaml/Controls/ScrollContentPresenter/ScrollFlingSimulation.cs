...
{
	// Android's OverScroller spline, in closed form.
	...
	// Android uses 160 here because its unit is the dp (1/160in); a WinUI DIP is 1/96in, so taking
	// Android's value as-is would make every fling travel 1.667x too far.
