...
public partial class InfoBar
{
	...
	public static DependencyProperty IsClosableProperty { get; } =
		DependencyProperty.Register(nameof(IsClosable), typeof(bool), typeof(InfoBar), new FrameworkPropertyMetadata(BoolBoxes.True, OnIsClosablePropertyChanged));
	...
	public static DependencyProperty IsIconVisibleProperty { get; } =
		DependencyProperty.Register(nameof(IsIconVisible), typeof(bool), typeof(InfoBar), new FrameworkPropertyMetadata(BoolBoxes.True, OnIsIconVisiblePropertyChanged));
	...
	public static DependencyProperty IsOpenProperty { get; } =
		DependencyProperty.Register(nameof(IsOpen), typeof(bool), typeof(InfoBar), new FrameworkPropertyMetadata(BoolBoxes.False, OnIsOpenPropertyChanged));
