...
public partial class RelativePanel
{
	...
	public static DependencyProperty AlignBottomWithPanelProperty
	{
		...
		get;
			...
			new FrameworkPropertyMetadata(defaultValue: Boxes.BoolBoxes.False, options: FrameworkPropertyMetadataOptions.AffectsMeasure, propertyChangedCallback: (s, e) => OnPositioningChanged(s)));
