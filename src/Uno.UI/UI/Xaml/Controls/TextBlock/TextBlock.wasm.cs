...
namespace Microsoft.UI.Xaml.Controls
{
	partial class TextBlock : FrameworkElement
	{
		...
		{
			if (_textTrimmingChanged || _textWrappingChanged || _maxLinesChanged)
			{
				_textTrimmingChanged = _textWrappingChanged = _maxLinesChanged = false;
				this.SetTextWrappingAndTrimming(textTrimming: TextTrimming, textWrapping: TextWrapping);
				this.SetMaxLines(MaxLines, TextWrapping);
			}
