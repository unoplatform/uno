	...
	public partial class SwipeControl
	{
		...
		private void UpdateTransforms()
		{
			...
			if (m_isHorizontal)
			{
				...
				_transform.SetValue(TranslateTransform.XProperty, Boxer.Box((double)_desiredPosition.X), DependencyPropertyValuePrecedences.Animations);
				_swipeStackPaneltransform.SetValue(TranslateTransform.XProperty, Boxer.Box((double)_desiredStackPanelPosition.X), DependencyPropertyValuePrecedences.Animations);
			}
			else
			{
				...
				// This is a workaround. We shouldn't have to set the property using Animation precedence.
				_transform.SetValue(TranslateTransform.YProperty, Boxer.Box((double)_desiredPosition.Y), DependencyPropertyValuePrecedences.Animations);
				_swipeStackPaneltransform.SetValue(TranslateTransform.YProperty, Boxer.Box((double)_desiredStackPanelPosition.Y), DependencyPropertyValuePrecedences.Animations);
			}
		}
