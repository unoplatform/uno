...
namespace Microsoft.UI.Xaml.Controls
{
	public partial class ScrollViewer
	{
		...
		public bool ChangeView(double? horizontalOffset, double? verticalOffset, float? zoomFactor, bool disableAnimation)
		{
			...
			{
				if (horizontalOffset is double horizontalIntent)
				{
					_horizontalOffsetIntent = horizontalIntent;
				}

				if (verticalOffset is double verticalIntent)
				{
					_verticalOffsetIntent = verticalIntent;
				}
			}
