...
/// <summary>
/// Android implementation of HTTP request headers for WebResourceRequested.
/// </summary>
public partial class CoreWebView2HttpRequestHeaders : IEnumerable<KeyValuePair<string, string>>
{
	...
	/// On Android, this modification will be applied by re-fetching the resource with HttpClient.
	/// </summary>
