...
//internal partial class CoreWebView2
//{
...
//		// For some reason, the native WebView requires _owner internal registration
//		// to avoid launching an external task, out of context of the current activity.
//		//
//		// _owner will still be used to handle extra activity with the native control.
