		...
		else
		{
			...
			switch (brush)
			{
				...
				case GradientBrush gradientBrush when gradientBrush.CanApplyToBorder(cornerRadius):
					...
					break;
				case LinearGradientBrush linearGradientBrush when linearGradientBrush.SupportsFauxGradientBorder():
					ApplySolidColorBorder(element, borderWidth, linearGradientBrush.MajorStopColor ?? linearGradientBrush.FallbackColorWithOpacity);
					break;
