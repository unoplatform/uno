...
{
	/// <summary>
	/// Represents a text control that makes suggestions to users as they enter text using
	/// a keyboard or pen (using ink and handwriting recognition). The app is notified when
	/// text has been changed by the user and is responsible for providing relevant suggestions
	/// for this control to display.
	/// </summary>
