...
{
	/// <summary>
	/// Identifies the <see cref="Diagnostics"/> dependency property.
	/// </summary>
	public static DependencyProperty DiagnosticsProperty { get; } = DependencyProperty.Register(
		nameof(Diagnostics),
		typeof(object),
	...
	/// <summary>
	/// Identifies the <see cref="FallbackContent"/> dependency property.
	/// </summary>
	public static DependencyProperty FallbackContentProperty { get; } = DependencyProperty.Register(
		...
		new FrameworkPropertyMetadata(
			...
			OnFallbackContentPropertyChanged));
	...
	/// </summary>
	public static DependencyProperty AnimationOptimizationProperty { get; } = DependencyProperty.Register(
		nameof(AnimationOptimization),
		typeof(PlayerAnimationOptimization),
		typeof(AnimatedVisualPlayer),
		new FrameworkPropertyMetadata(PlayerAnimationOptimization.Latency, OnAnimationOptimizationPropertyChanged));
	...
	/// <summary>
	/// Gets a diagnostics object that the source can populate when it creates or updates the animated visual.
	/// </summary>
	...
	/// <summary>
	/// Gets or sets a value that controls when the player's animations are created and destroyed.
	/// </summary>
	...
	/// <summary>
	/// Gets the CompositionObject of the animated visual.
	/// </summary>
	public Microsoft.UI.Composition.CompositionObject ProgressObject => m_progressPropertySet;
	...
	private static void OnSourcePropertyChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
		=> (source as AnimatedVisualPlayer)?.OnSourcePropertyChanged(args);

	private static void OnAutoPlayPropertyChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
		=> (source as AnimatedVisualPlayer)?.OnAutoPlayPropertyChanged(args);

	private static void OnAnimationOptimizationPropertyChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
		=> (source as AnimatedVisualPlayer)?.OnAnimationOptimizationPropertyChanged(args);

	private static void OnPlaybackRatePropertyChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
		=> (source as AnimatedVisualPlayer)?.OnPlaybackRatePropertyChanged(args);

	private static void OnFallbackContentPropertyChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
		=> (source as AnimatedVisualPlayer)?.OnFallbackContentPropertyChanged(args);

	private static void OnStretchPropertyChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
		=> (source as AnimatedVisualPlayer)?.OnStretchPropertyChanged(args);
}
