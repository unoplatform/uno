...
public partial class NavigationViewTemplateSettings : DependencyObject
{
	...
	public double PaneToggleButtonWidth
	{
		...
		internal set => SetValue(PaneToggleButtonWidthProperty, Boxer.Box(value));
	}
	...
	public static DependencyProperty PaneToggleButtonWidthProperty { get; } =
		DependencyProperty.Register(nameof(PaneToggleButtonWidth), typeof(double), typeof(NavigationViewTemplateSettings), new FrameworkPropertyMetadata(DoubleBoxes.Zero));
	...
	public static DependencyProperty SingleSelectionFollowsFocusProperty { get; } =
		DependencyProperty.Register(nameof(SingleSelectionFollowsFocus), typeof(bool), typeof(NavigationViewTemplateSettings), new FrameworkPropertyMetadata(BoolBoxes.False));
	...
	public double SmallerPaneToggleButtonWidth
	{
		...
		internal set => SetValue(SmallerPaneToggleButtonWidthProperty, Boxer.Box(value));
	}
	...
	public static DependencyProperty SmallerPaneToggleButtonWidthProperty { get; } =
		DependencyProperty.Register(nameof(SmallerPaneToggleButtonWidth), typeof(double), typeof(NavigationViewTemplateSettings), new FrameworkPropertyMetadata(DoubleBoxes.Zero));
	...
	public double TopPadding
	{
		...
		internal set => SetValue(TopPaddingProperty, Boxer.Box(value));
	}
	...
	public static DependencyProperty TopPaddingProperty { get; } =
		DependencyProperty.Register(nameof(TopPadding), typeof(double), typeof(NavigationViewTemplateSettings), new FrameworkPropertyMetadata(DoubleBoxes.Zero));
