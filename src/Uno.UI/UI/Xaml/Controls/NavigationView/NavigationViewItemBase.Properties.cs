...
public partial class NavigationViewItemBase
{
	...
	public static DependencyProperty IsSelectedProperty { get; } =
		DependencyProperty.Register(nameof(IsSelected), typeof(bool), typeof(NavigationViewItemBase), new FrameworkPropertyMetadata(BoolBoxes.False, OnIsSelectedPropertyChanged));
