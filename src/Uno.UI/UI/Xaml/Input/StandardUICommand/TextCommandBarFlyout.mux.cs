...
partial class TextCommandBarFlyout
{
	...
	//				(SecondaryCommands().Size() == 0 || (!m_commandBar.IsOpen() && !showModeIsStandard)))
	//			{
	//				Hide();
	//			}
	//		}
 ...
 //               {
	...
	//					for (uint i = 0; i < currentItems.Size(); i++)
	//					{
 ...
 //       {
	...
	//TextControlButtons GetTextBoxButtonsToAdd(TextBox & textBox)
	//{
	//	TextControlButtons buttonsToAdd = TextControlButtons.None;
	...
	//		var textBox8 = textBox as ITextBox8();
	...
	//TextControlButtons GetTextBlockButtonsToAdd(TextBlock & textBlock)
	//{
	//	TextControlButtons buttonsToAdd = TextControlButtons.None;
	...
	//TextControlButtons GetRichEditBoxButtonsToAdd(RichEditBox & richEditBox)
	//{
	//	TextControlButtons buttonsToAdd = TextControlButtons.None;
	//	var document{ richEditBox.Document() };
	//	var selection{ document? document.Selection() : null };

	//	if (!richEditBox.IsReadOnly())
	//	{
	//		if (var richEditBox6 = richEditBox as IRichEditBox6())
 //       {
	...
	//TextControlButtons GetRichTextBlockButtonsToAdd(RichTextBlock & richTextBlock)
	//{
	//	TextControlButtons buttonsToAdd = TextControlButtons.None;
	...
	//TextControlButtons GetPasswordBoxButtonsToAdd(PasswordBox & passwordBox)
	//{
	//	TextControlButtons buttonsToAdd = TextControlButtons.None;
