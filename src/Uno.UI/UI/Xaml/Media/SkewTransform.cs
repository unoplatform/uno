...
namespace Microsoft.UI.Xaml.Media
{
	...
	public partial class SkewTransform : Transform
	{
		...
		public static DependencyProperty CenterYProperty { get; } =
			DependencyProperty.Register("CenterY", typeof(double), typeof(SkewTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));
		...
		public static DependencyProperty CenterXProperty { get; } =
			DependencyProperty.Register("CenterX", typeof(double), typeof(SkewTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));

		public double AngleX
		{
			get => (double)this.GetValue(AngleXProperty);
			set => this.SetValue(AngleXProperty, Boxer.Box(value));
		}

		public static DependencyProperty AngleXProperty { get; } =
			DependencyProperty.Register("AngleX", typeof(double), typeof(SkewTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));


		public double AngleY
		{
			get => (double)this.GetValue(AngleYProperty);
			set => this.SetValue(AngleYProperty, Boxer.Box(value));
		}

		public static DependencyProperty AngleYProperty { get; } =
			DependencyProperty.Register("AngleY", typeof(double), typeof(SkewTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));
	}
}
