...
#pragma warning restore CS0067 // The event is never used
		...
		public static DependencyProperty DecodePixelWidthProperty { get; } =
			DependencyProperty.Register("DecodePixelWidth", typeof(int), typeof(BitmapImage), new FrameworkPropertyMetadata(IntegerBoxes.Zero, (s, e) => ((BitmapImage)s)?.OnDecodePixelWidthChanged(e)));
		...
		public static DependencyProperty DecodePixelHeightProperty { get; } =
			DependencyProperty.Register("DecodePixelHeight", typeof(int), typeof(BitmapImage), new FrameworkPropertyMetadata(IntegerBoxes.Zero, (s, e) => ((BitmapImage)s)?.OnDecodePixelHeightChanged(e)));
