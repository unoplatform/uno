...
namespace Microsoft.UI.Xaml.Media.Animation
{
	public partial class KeySpline : DependencyObject
	{
		...
		public static KeySpline FromString(string input)
		{
			...
			if (tokens.Count != 4)
			{
				throw new ArgumentOutOfRangeException("A KeySpline must have 4 tokens: x1, y1, x2, y2. Yours had {0} (input: \"{1}\").".InvariantCultureFormat(Boxer.Box(tokens.Count), input));
			}
