...
namespace Microsoft.UI.Xaml.Media
{
	...
	public partial class CompositeTransform : Transform
	{
		...
		public static DependencyProperty CenterXProperty { get; } =
			DependencyProperty.Register("CenterX", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));
		...
		public static DependencyProperty CenterYProperty { get; } =
			DependencyProperty.Register("CenterY", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));

		public double Rotation
		{
			get => (double)this.GetValue(RotationProperty);
			set => this.SetValue(RotationProperty, Boxer.Box(value));
		}

		public static DependencyProperty RotationProperty { get; } =
			DependencyProperty.Register("Rotation", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));
		...
		public static DependencyProperty ScaleXProperty { get; } =
			DependencyProperty.Register("ScaleX", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.One, NotifyChangedCallback));
		...
		public static DependencyProperty ScaleYProperty { get; } =
			DependencyProperty.Register("ScaleY", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.One, NotifyChangedCallback));

		public double SkewX
		{
			get => (double)this.GetValue(SkewXProperty);
			set => this.SetValue(SkewXProperty, Boxer.Box(value));
		}

		public static DependencyProperty SkewXProperty { get; } =
			DependencyProperty.Register("SkewX", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));

		public double SkewY
		{
			get => (double)this.GetValue(SkewYProperty);
			set => this.SetValue(SkewYProperty, Boxer.Box(value));
		}

		public static DependencyProperty SkewYProperty { get; } =
			DependencyProperty.Register("SkewY", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));

		public double TranslateX
		{
			get => (double)this.GetValue(TranslateXProperty);
			set => this.SetValue(TranslateXProperty, Boxer.Box(value));
		}

		public static DependencyProperty TranslateXProperty { get; } =
			DependencyProperty.Register("TranslateX", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));

		public double TranslateY
		{
			get => (double)this.GetValue(TranslateYProperty);
			set => this.SetValue(TranslateYProperty, Boxer.Box(value));
		}

		public static DependencyProperty TranslateYProperty { get; } =
			DependencyProperty.Register("TranslateY", typeof(double), typeof(CompositeTransform), new FrameworkPropertyMetadata(DoubleBoxes.Zero, NotifyChangedCallback));
