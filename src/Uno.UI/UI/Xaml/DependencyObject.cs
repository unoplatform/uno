		...
		public static DependencyProperty DataContextProperty { get; } =
			DependencyProperty.Register(
				...
				typeMetadata: new FrameworkPropertyMetadata(
					...
					propertyChangedCallback: (s, e) => ((DependencyObject)s).OnDataContextChanged(e)
				)
		);

		internal protected virtual void OnDataContextChanged(DependencyPropertyChangedEventArgs e)
		{
			DataContextChanged?.Invoke(this as FrameworkElement, new DataContextChangedEventArgs(DataContext));
		}
