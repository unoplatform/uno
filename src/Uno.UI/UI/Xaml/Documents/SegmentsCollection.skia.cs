...
partial class SegmentsCollection<T>
{
	...
	internal Size Measure(Size availableSize, float defaultLineHeight)
	{
		...
		var parent = (ISegmentsElement)this.GetParent();
	...
	/// <summary>
	/// Renders a block-level inline collection, i.e. one that belongs to a TextBlock or Paragraph
	/// </summary>
