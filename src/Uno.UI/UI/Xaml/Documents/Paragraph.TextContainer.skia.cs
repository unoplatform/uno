...
// MUX Reference paragraph.cpp, tag winui3/release/2.4.0, commit e8442d07a
...
partial class Paragraph
{
		...
		out TextElement? ppContainingElement)
	{
		...
		// WinUI tests `m_pInlines`, which stays null until the paragraph actually gets inlines.
