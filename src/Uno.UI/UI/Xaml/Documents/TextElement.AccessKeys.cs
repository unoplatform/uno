...
// MUX Reference dxaml\xcp\core\text\RichTextArea\TextElement.cpp, tag winui3/release/1.5.3
...
partial class TextElement
{
	...
	private TypedEventHandler<TextElement, AccessKeyInvokedEventArgs>? _accessKeyInvoked;
	private TypedEventHandler<TextElement, AccessKeyDisplayRequestedEventArgs>? _accessKeyDisplayRequested;
	private TypedEventHandler<TextElement, AccessKeyDisplayDismissedEventArgs>? _accessKeyDisplayDismissed;
	...
	/// </summary>
	internal void AddAccessKeyInvokedHandler(TypedEventHandler<TextElement, AccessKeyInvokedEventArgs> handler)
	{
	...
	/// </summary>
	internal void RemoveAccessKeyInvokedHandler(TypedEventHandler<TextElement, AccessKeyInvokedEventArgs> handler)
	{
		_accessKeyInvoked -= handler;
	}
	...
	/// </summary>
	internal void AddAccessKeyDisplayRequestedHandler(TypedEventHandler<TextElement, AccessKeyDisplayRequestedEventArgs> handler)
	{
	...
	/// </summary>
	internal void RemoveAccessKeyDisplayRequestedHandler(TypedEventHandler<TextElement, AccessKeyDisplayRequestedEventArgs> handler)
	{
		_accessKeyDisplayRequested -= handler;
	}
	...
	/// </summary>
	internal void AddAccessKeyDisplayDismissedHandler(TypedEventHandler<TextElement, AccessKeyDisplayDismissedEventArgs> handler)
	{
	...
	/// </summary>
	internal void RemoveAccessKeyDisplayDismissedHandler(TypedEventHandler<TextElement, AccessKeyDisplayDismissedEventArgs> handler)
	{
		_accessKeyDisplayDismissed -= handler;
	}
}
