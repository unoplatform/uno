...
public partial class TransformPatternIdentifiers
{
	...
	/// </summary>
	public static AutomationProperty CanMoveProperty => new();

	/// <summary>
	/// Identifies the CanResize automation property.
	/// </summary>
	public static AutomationProperty CanResizeProperty => new();

	/// <summary>
	/// Identifies the CanRotate automation property.
	/// </summary>
	public static AutomationProperty CanRotateProperty => new();
}
