...
public partial class AutomationElementIdentifiers
{
	...
	/// </summary>
	public static AutomationProperty IsContentElementProperty => new();
	...
	/// </summary>
	public static AutomationProperty IsControlElementProperty => new();
	...
	/// </summary>
	public static AutomationProperty IsEnabledProperty => new();
	...
	/// </summary>
	public static AutomationProperty IsKeyboardFocusableProperty => new();
	...
	/// </summary>
	public static AutomationProperty IsOffscreenProperty => new();
	...
	/// </summary>
	public static AutomationProperty IsPasswordProperty => new();
	...
	/// </summary>
	public static AutomationProperty LabeledByProperty => new();
	...
	/// </summary>
	public static AutomationProperty LiveSettingProperty => new();
	...
	/// </summary>
	public static AutomationProperty LocalizedControlTypeProperty => new();

	/// <summary>
	/// Identifies the class name automation property. The class name property value is returned by the GetClassName method.
	/// </summary>
	public static AutomationProperty NameProperty => new();
	...
	/// </summary>
	public static AutomationProperty AutomationIdProperty => new();

	/// <summary>
	/// Identifies the orientation automation property. The current orientation value is returned by the GetOrientation method.
	/// </summary>
	public static AutomationProperty OrientationProperty => new();

	/// <summary>
	/// Identifies the class name automation property. The class name property value is returned by the GetClassName method.
	/// </summary>
	public static AutomationProperty ClassNameProperty => new();
	...
	/// </summary>
	public static AutomationProperty ClickablePointProperty => new();
	...
	/// </summary>
	public static AutomationProperty ControlTypeProperty => new();
	...
	/// </summary>
	public static AutomationProperty CultureProperty => new();
	...
	/// </summary>
	public static AutomationProperty HeadingLevelProperty => new();
	...
	/// </summary>
	public static AutomationProperty IsDialogProperty => new();
}
