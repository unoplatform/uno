...
namespace Microsoft.UI.Xaml
{
	...
	partial class UIElement
	{
...
#endif
			global::System.Diagnostics.Trace.Assert(routedEvent.Flag is not RoutedEventFlag.None, $"Flag not defined for routed event {routedEvent.Name}.");

#if !__WASM__
			global::System.Diagnostics.Trace.Assert(!routedEvent.IsTunnelingEvent, $"Tunneling event {routedEvent.Name} should be raised through {nameof(RaiseTunnelingEvent)}");
#endif
		...
		{
			global::System.Diagnostics.Trace.Assert(routedEvent.IsTunnelingEvent, $"Event {routedEvent.Name} is not marked as a tunneling event.");
