...
namespace Microsoft.UI.Xaml.Data
{
	public partial class CollectionViewSource : DependencyObject
	{
		...
		public static DependencyProperty IsSourceGroupedProperty { get; } =
			DependencyProperty.Register(nameof(IsSourceGrouped), typeof(bool), typeof(CollectionViewSource), new FrameworkPropertyMetadata(defaultValue: Boxes.BoolBoxes.False, propertyChangedCallback: (o, e) => ((CollectionViewSource)o).UpdateView()));
