...
public class Win32Host : SkiaHost, ISkiaApplicationHost
{
	...
	static Win32Host()
	{
		...
		ApiExtensibility.Register<Windows.UI.ViewManagement.InputPane>(typeof(Windows.UI.ViewManagement.IInputPaneExtension), inputPane => new Win32InputPaneExtension(inputPane));
