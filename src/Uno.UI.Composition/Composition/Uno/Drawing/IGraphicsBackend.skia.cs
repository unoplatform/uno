...
/// <see cref="Drawing"/> factory and the <see cref="IRenderBackend"/> that consumes its handles. Registering
/// the pair together (see <see cref="GraphicsBackend"/>) makes "a renderer without its matched factory"
...
public interface IGraphicsBackend
{
	...
	/// <summary>The resource/content factory. Installed as <see cref="DrawingBackend.Current"/> when this backend wins negotiation.</summary>
