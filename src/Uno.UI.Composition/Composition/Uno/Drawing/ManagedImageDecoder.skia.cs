...
/// <c>UNO_MANAGED_IMAGE_DECODER=1</c>; unsupported inputs return false so the caller falls back to the Skia codec.
/// </summary>
internal static partial class ManagedImageDecoder
{
	/// <summary>Whether the managed decoder is enabled (env <c>UNO_MANAGED_IMAGE_DECODER=1</c>).</summary>
	public static bool Enabled { get; } =
		Environment.GetEnvironmentVariable("UNO_MANAGED_IMAGE_DECODER") is "1" or "true";
