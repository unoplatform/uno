	...
	public override object Evaluate(ExpressionAnimation expressionAnimation)
	{
		...
		if (_operatorToken.Kind == ExpressionAnimationTokenKind.PlusToken)
		{
			return (leftValue, rightValue) switch
			{
				...
				(float leftFloat, double rightDouble) => leftFloat + rightDouble,
				(double leftDouble, float rightFloat) => leftDouble + rightFloat,
				...
				(int leftInt, double rightDouble) => leftInt + rightDouble,
				(double leftDouble, int rightInt) => leftDouble + rightInt,
