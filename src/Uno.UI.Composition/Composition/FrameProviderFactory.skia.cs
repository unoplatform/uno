...
/// <summary>
/// Builds the right <see cref="IFrameProvider"/> for a set of decoded <see cref="ImageFrames"/>: a still image
...
{
	public static IFrameProvider Create(ImageFrames frames, Action? onFrameChanged)
