...
1. In your `.csproj`, add the `net11.0-desktop` target framework to the `TargetFrameworks` property.
1. Save your solution.

Your new platform project is now ready to be compiled.

You can repeat a similar process for `net11.0-ios`, `net11.0-android`, `net11.0-browserwasm`, and `net11.0-windows10.0.xxxxx`.
