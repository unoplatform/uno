...
---
# Creating an app with Visual Studio
...
- In the "Debug toolbar" drop-down, select framework `net11.0-ios`:

    ![Visual Studio - "Debug toolbar" drop-down selecting the "net11.0-ios" framework](Assets/quick-start/ios-debug.png)
...
- In the **Debug toolbar** drop-down, select framework `net11.0-android`

    ![Visual Studio - "Debug toolbar" drop-down selecting the "net11.0-android" framework](Assets/quick-start/android-debug.png)
