...
The AppBarButton documentation is now on its [own page](AppBarButton.md).
...
- > How can I use a Path for the AppBarButton Icon?
  ...
  `AppBarButton` doesn't currently support `PathIcon`. Only `BitmapIcon` with PNGs is supported. Please refer to the [AppBarButton Icon](AppBarButton.md#icon) section.
...
- > What size should my AppBarButton icons be?
  ...
  Please refer to the [AppBarButton Icon](AppBarButton.md#icon) section for details.
