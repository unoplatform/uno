...
To ease the adjustments when conversion issues arrise:
...
You'll need to ensure that the `crosstargeting_override.props` file is not defininig `UnoTargetFrameworkOverride` otherwise the UWPSyncGenerator will generate an invalid API set.
