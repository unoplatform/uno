...
=======
> [!NOTE]
>>>>>>> 584ebb5163 (chore: Progress fixing markdownlint rules)
...
1. Open the appropriate Uno.UI solution filter and build the **Uno.UI** project (or **Uno.UI.WebAssembly**/**Uno.UI.Skia** projects for WebAssembly or Skia).
>>>>>>> 584ebb5163 (chore: Progress fixing markdownlint rules)
