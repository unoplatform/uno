...
- Build your app using the following command:
    ...
    ```pwsh
    msbuild /r /p:TargetFramework=net11.0-windows10.0.26100 /p:Configuration=Release /p:Platform=x64 /p:GenerateAppxPackageOnBuild=true /p:AppxBundle=Never /p:UapAppxPackageBuildMode=Sideloading /p:AppxPackageDir="C:/temp/output/" /p:AppxPackageSigningEnabled=false
    ```
...
- Then run this command:
  ...
  ```pwsh
  msbuild /p:TargetFramework=net11.0-windows10.0.26100 /p:Configuration=Release /p:Platform=x64 /p:PublishUnsignedPackage=true /p:AppxPackageDir="C:/temp/output/"
  ```
