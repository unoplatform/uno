...
If you need to stay on .NET 8, you can continue to use **Uno Platform 6.2 or earlier** and plan your migration to .NET 9 or .NET 10.

### .NET 10 RC1

Uno Platform 6.3 is now built with .NET 10 support, allowing you to upgrade existing ones or create new projects using the wizard.
A few considerations to take into account:

- Moving to .NET 10 or upgrading .NET 10 projects requires the use of .NET 10 RC1 and latest version of [Visual Studio 2026 Insiders](https://visualstudio.microsoft.com/insiders/) as recommended by Microsoft in this [announcement](https://devblogs.microsoft.com/dotnet/dotnet-10-rc-1/#🚀-get-started).
