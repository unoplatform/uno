...
This method has been been removed as is it not available in WinUI. You can migrate code using this method to use the `FrameworkElement.Loaded` event instead.
