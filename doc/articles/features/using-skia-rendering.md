...
> [!NOTE]
> Starting with Uno Platform 6.0, **Mac Catalyst** is no longer supported, and we encourage users to move to `netX.0-desktop`, which runs on macOS using Skia for rendering.
