...
| Topic | Description |
|-------|-------------|
| [AutomationProperties reference](automation-properties.md) | All supported `AutomationProperties` with XAML examples and per-platform support |
| [Custom automation peers](automation-peers.md) | How to create custom `AutomationPeer` implementations for custom controls |
...
| [Controls accessibility reference](controls-reference.md) | Per-control accessibility behavior, expected screen reader announcements, and keyboard interactions |
| [Testing with screen readers](testing-with-screen-readers.md) | Setup guides for VoiceOver, NVDA, and Narrator; what to test; debugging tips |
| [AccessibilitySettings and options](accessibility-settings.md) | High-contrast settings, text scaling, and other accessibility configuration |
