...
> [!TIP]
> Beginning with 5.2, Uno.Sdk enabled projects are best experienced using the [MSBuild Editor Visual Studio 2022/2026 Extension](https://marketplace.visualstudio.com/items?itemName=mhutch.msbuildeditor) to provide intellisense.
...
## Visual Studio 2022/2026 First-TargetFramework workarounds

Using a Single Project in Visual Studio 2022/2026 requires the Uno Platform tooling to apply workarounds in order to have an acceptable debugging experience.
