...
- **[Controls accessibility reference](accessibility/controls-reference.md)** — Per-control behavior and keyboard interactions
- **[Testing with screen readers](accessibility/testing-with-screen-readers.md)** — Setup, shortcuts, and debugging guide
- **[AccessibilitySettings and options](accessibility/accessibility-settings.md)** — High contrast, text scaling, SimpleAccessibility (legacy)
