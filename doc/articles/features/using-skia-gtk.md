...
```xml
<ItemGroup>
   <PackagReference Include="SkiaSharp" Version="3.119.0-preview.0.11" />
   <PackagReference Include="SkiaSharp.Harfbuzz" Version="3.119.0-preview.0.11" />
   <PackagReference Include="SkiaSharp.NativeAssets.Linux" Version="3.119.0-preview.0.11" />
   <PackageReference Update="SkiaSharp.NativeAssets.macOS" Version="3.119.0-preview.0.11" />
</ItemGroup>
```
