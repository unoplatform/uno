...
```xml
<ItemGroup>
   <PackagReference Include="SkiaSharp" Version="2.88.8" />
   <PackagReference Include="SkiaSharp.Harfbuzz" Version="2.88.8" />
   <PackagReference Include="SkiaSharp.NativeAssets.Linux" Version="2.88.8" />
   <PackageReference Update="SkiaSharp.NativeAssets.macOS" Version="2.88.8" />
</ItemGroup>
```
