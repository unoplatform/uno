...
```xml
<ItemGroup>
   <PackagReference Include="SkiaSharp" Version="4.148.0" />
   <PackagReference Include="SkiaSharp.NativeAssets.Linux" Version="4.148.0" />
   <PackageReference Update="SkiaSharp.NativeAssets.macOS" Version="4.148.0" />
   <PackagReference Include="HarfBuzzSharp" Version="14.2.0" />
</ItemGroup>
```
