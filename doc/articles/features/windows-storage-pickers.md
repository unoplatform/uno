...
To get the Window, you need to retrieve it. For single-window apps it is easiest to make the `_window` field in the `App.xaml.cs` file `internal static` and then use it for this purpose:
