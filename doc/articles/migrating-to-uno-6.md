...
To fix this issue, add the following to your `.csproj` file to ensure the correct Windows SDK is referenced for the `net11.0-windowsXX` target to build properly:
