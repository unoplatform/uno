...
$external_docs = @{
    ...
    "uno.toolkit.ui" = @{ ref="650d07f518c864e9d1cac3be74b650eb9e1be053" } #latest main commit
    ...
    "uno.extensions" = @{ ref="fdcb92aeca44432dec75d9c0d371fc0ba607813e" } #latest main commit
