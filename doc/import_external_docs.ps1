...
@(
    ...
    @("https://github.com/unoplatform/uno.check", "uno.check", "a90cab518de22d768b627e16458d0b30064460db"),
    ...
    @("https://github.com/unoplatform/uno.extensions", "uno.extensions", "5478158bbf9cba9f8da043a9351f61c5150370cb")
)
