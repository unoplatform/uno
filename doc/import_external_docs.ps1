...
$external_docs = @{
    ...
    "uno.toolkit.ui" = @{ ref="edaba75783e69ee00830951bd482e05182ad03b5" } #latest main commit
    "uno.check" = @{ ref="af2ea18ab771a55d24aa25142f7613782a06dac7" } #latest main commit
    ...
    "uno.extensions" = @{ ref="3a6a0145636530b73d0d8199696f6b878e6ef593" } #latest main commit
