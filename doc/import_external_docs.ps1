...
$external_docs = @{
    ...
    "uno.toolkit.ui" = @{ ref="fc5c551ee054cccd4aa7a9af3e38f14596ed199c" } #latest main commit
    "uno.check" = @{ ref="37560fbb3514d8b43d537f4b33429944a75a280c" } #latest main commit
    ...
    "uno.extensions" = @{ ref="456ee65442960ecfd28eff7c32c418cfc135bffd" } #latest main commit
