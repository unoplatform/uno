...
$external_docs = @{
    ...
    "uno.themes"         = "911af3ae03567841e01b47751fb13bbecfd7bebf" #latest release branch commit
    "uno.toolkit.ui"     = "1ed54bc684825827ac0dcb891a1a8a46c4dc8acf" #latest release branch commit
