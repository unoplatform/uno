...
$external_docs = @{
    ...
    "uno.toolkit.ui"     = @{ ref="2e66411fc3e804165d2178eda0083e3b52a877c0" } #latest release/stable/8.3 branch commit
    ...
    "hd-docs"            = @{ ref="08ef7f52f5d1b8b0906836fb5e431dd7ebd078fd"; dest="studio/Hot Design" } #latest main commit
}
