...
$external_docs = @{
    ...
    "uno.toolkit.ui"     = @{ ref="f9ad44d4a75835e3fff4a67660dac05b410e5bed" } #latest release/stable/8.2 branch commit
    ...
    "uno.extensions"     = @{ ref="f538ca502063109d365154a98d6fd4288909ca0e" } #latest release/stable/6.2 branch commit
