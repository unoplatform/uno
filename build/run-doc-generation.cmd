...
pause
msbuild Uno.UI.Build.csproj /r "/p:CombinedConfiguration=Release|AnyCPU;BUILD_BUILDNUMBER=test_test_8888" /m /t:GenerateDoc /clp:PerformanceSummary;Summary /bl
pause
