...
npm i chromedriver@106.0.0
npm i puppeteer@17.1.0
...
# export UNO_UITEST_CHROME_BINARY_PATH=~/.cache/puppeteer/chrome/linux-1036745/chrome-linux/chrome
export UNO_UITEST_CHROME_BINARY_PATH=$BUILD_SOURCESDIRECTORY/build/wasm-uitest-binaries/node_modules/puppeteer/.local-chromium/linux-1036745/chrome-linux/chrome
