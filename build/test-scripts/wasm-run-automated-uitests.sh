...
then
	export TEST_FILTERS="Namespace != SamplesApp.UITests.Snap & FullyQualifiedName !~ SamplesApp.UITests.Runtime.RuntimeTests & FullyQualifiedName !~ SamplesApp.UITests.Runtime.BenchmarkDotNetTests"
