...
mono '/Applications/Visual Studio.app/Contents/MonoBundle/MSBuild/Current/bin/MSBuild.dll' /m /r /p:Configuration=$BUILDCONFIGURATION /p:UnoUIUseRoslynSourceGenerators=true /p:AndroidUseLatestPlatformSdk=true $BUILD_SOURCESDIRECTORY/src/SamplesApp/SamplesApp.Droid/SamplesApp.Droid.csproj
