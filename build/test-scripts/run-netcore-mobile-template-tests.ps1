...
if ( ($TestGroup -eq 0) -and ($env:UWPBuildEnabled -eq 'True') )
{
    ...
    @(
        @("Mobile", "-f:net9.0-android", ""), # workaround for https://github.com/xamarin/xamarin-android/issues/7473
        @("Mobile", "-f:net9.0-ios", ""),
        @("Mobile", "-f:net9.0-maccatalyst", ""),
        @("Wasm", "", ""),
    ...
    if ($IsWindows) 
    {
        ...
        & $msbuild $debug "/p:Platform=x86" "UnoAppWinUI.Windows\UnoAppWinUI.Windows.csproj" "/p:TargetFrameworks=net9.0-windows10.0.19041;TargetFramework=net9.0-windows10.0.19041" "/bl:../binlogs/UnoAppWinUI.Windows/debug/$i/msbuild.binlog"
        Assert-ExitCodeIsZero
    }
    ...
    if ($IsWindows) 
    {
        ...
        $responseFile = @(
            ...
            "/p:TargetFrameworks=""net9.0-windows10.0.19041;net9.0"""
        )
...
@(
    ...
    # 5.2 Blank
    #
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0"), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0", $sdkFeatures), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-browserwasm"), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-browserwasm", $sdkFeatures), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-ios"), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-ios", $sdkFeatures), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-android"), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-android", $sdkFeatures), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-maccatalyst"), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-maccatalyst", $sdkFeatures), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-desktop"), @("macOS", "NetCore")),
    @(1, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-f", "net9.0-desktop", $sdkFeatures), @("macOS", "NetCore")),

    # Default mode for the template is WindowsAppSDKSelfContained=true, which requires specifying a target platform.
    @(2, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-p:Platform=x86" , "-p:TargetFramework=net9.0-windows10.0.19041"), @()),
    @(2, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-p:Platform=arm64" , "-p:TargetFramework=net9.0-windows10.0.19041"), @()),

    # Ensure that default without platform builds properly
    @(2, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-p:TargetFramework=net9.0-windows10.0.19041"), @()),

    # Validate building inside VS
    @(2, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-p:BuildingInsideVisualStudio=true"), @("NetCore")),
    @(2, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-p:BuildingInsideVisualStudio=true", "-p:_UnoSelectedTargetFramework=net9.0-desktop"), @("NetCore")),
    @(2, "5.2/uno52blank/uno52blank/uno52blank.csproj", @("-p:BuildingInsideVisualStudio=true", "-p:_UnoSelectedTargetFramework=net9.0-windows10.0.19041"), @()),

    #
    # 5.2 Uno Lib
    #
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0"), @("macOS", "NetCore")),
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0-browserwasm"), @("macOS", "NetCore")),
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0-ios"), @("macOS", "NetCore")),
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0-android"), @("macOS", "NetCore")),
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0-maccatalyst"), @("macOS", "NetCore")),
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0-desktop"), @("macOS", "NetCore")),
    
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0-browserwasm", "-p:ImplicitUsings=disable"), @("macOS", "NetCore")),
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-f", "net9.0-desktop", "-p:ImplicitUsings=disable"), @("macOS", "NetCore")),
    ...
    # Default mode for the template is WindowsAppSDKSelfContained=true, which requires specifying a target platform.
    @(2, "5.2/uno52Lib/uno52Lib.csproj", @("-p:Platform=x86" , "-p:TargetFramework=net9.0-windows10.0.19041"), @("macOS")),

    #
    # 5.2 Uno SingleProject Lib
    #
    @(2, "5.2/uno52SingleProjectLib/uno52SingleProjectLib.csproj", @("-f", "net9.0"), @("macOS", "NetCore")),
    @(2, "5.2/uno52SingleProjectLib/uno52SingleProjectLib.csproj", @("-f", "net9.0-browserwasm"), @("macOS", "NetCore")),
    @(2, "5.2/uno52SingleProjectLib/uno52SingleProjectLib.csproj", @("-f", "net9.0-ios"), @("macOS", "NetCore")),
    @(2, "5.2/uno52SingleProjectLib/uno52SingleProjectLib.csproj", @("-f", "net9.0-android"), @("macOS", "NetCore")),
    @(2, "5.2/uno52SingleProjectLib/uno52SingleProjectLib.csproj", @("-f", "net9.0-maccatalyst"), @("macOS", "NetCore")),
    @(2, "5.2/uno52SingleProjectLib/uno52SingleProjectLib.csproj", @("-f", "net9.0-desktop"), @("macOS", "NetCore")),

    # Default mode for the template is WindowsAppSDKSelfContained=true, which requires specifying a target platform.
    @(2, "5.2/uno52SingleProjectLib/uno52SingleProjectLib.csproj", @("-p:Platform=x86" , "-p:TargetFramework=net9.0-windows10.0.19041"), @()),

    # 5.2 Uno App with Library reference
    @(2, "5.2/uno52AppWithLib/uno52AppWithLib/uno52AppWithLib.csproj", @("-f", "net9.0"), @("macOS", "NetCore")),
    @(2, "5.2/uno52AppWithLib/uno52AppWithLib/uno52AppWithLib.csproj", @("-f", "net9.0-browserwasm"), @("macOS", "NetCore")),
    @(2, "5.2/uno52AppWithLib/uno52AppWithLib/uno52AppWithLib.csproj", @("-f", "net9.0-ios"), @("macOS", "NetCore")),
    @(2, "5.2/uno52AppWithLib/uno52AppWithLib/uno52AppWithLib.csproj", @("-f", "net9.0-android"), @("macOS", "NetCore")),
    @(2, "5.2/uno52AppWithLib/uno52AppWithLib/uno52AppWithLib.csproj", @("-f", "net9.0-maccatalyst"), @("macOS", "NetCore")),
    @(2, "5.2/uno52AppWithLib/uno52AppWithLib/uno52AppWithLib.csproj", @("-f", "net9.0-desktop"), @("macOS", "NetCore")),

    # 5.3 Uno App with net9
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0"), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0", $sdkFeatures), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-browserwasm"), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-browserwasm", $sdkFeatures), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-browserwasm", "-p:UseArtifactsOutput=true", "-p:UnoXamlResourcesTrimming=true"), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-ios"), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-ios", $sdkFeatures), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-android"), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-android", $sdkFeatures), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-maccatalyst"), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-maccatalyst", $sdkFeatures), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-desktop"), @("macOS", "NetCore")),
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-desktop", $sdkFeatures), @("macOS", "NetCore")),

    # Default mode for the template is WindowsAppSDKSelfContained=true, which requires specifying a target platform.
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-p:Platform=x86" , "-p:TargetFramework=net10.0-windows10.0.19041"), @()),

    # 5.3 Library
    @(3, "5.3/uno53net9Lib/uno53net9Lib.csproj", @(), @("macOS", "NetCore")),

    # Default mode for the template is WindowsAppSDKSelfContained=true, which requires specifying a target platform.
    @(4, "5.2/uno52AppWithLib/uno52AppWithLib/uno52AppWithLib.csproj", @("-p:Platform=x86" , "-p:TargetFramework=net9.0-windows10.0.19041"), @()),

    # Publishing validation
    @(4, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net10.0-desktop", "-p:PackageFormat=app"), @("OnlyMacOS", "NetCore", "Publish")),
    ...
    # 5.6 Wasm+Skia
    @(4, "5.6/uno56wasmskia/uno56wasmskia/uno56wasmskia.csproj", @("-f", "net10.0-browserwasm"), @("macOS", "NetCore")),
