...
if ( ($TestGroup -eq 0) -and ($env:UWPBuildEnabled -eq 'True') )
{
    ...
    @(
        @("Mobile", "-f:net11.0-android", ""), # workaround for https://github.com/xamarin/xamarin-android/issues/7473
        @("Mobile", "-f:net11.0-ios", ""),
        @("Mobile", "-f:net11.0-maccatalyst", ""),
        @("Wasm", "", ""),
...
@(
    ...
    @(1, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net11.0-ios"), @("macOS", "NetCore")),
    @(1, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net11.0-ios", $sdkFeatures), @("macOS", "NetCore")),
    ...
    @(1, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net11.0-maccatalyst"), @("macOS", "NetCore")),
    @(1, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net11.0-maccatalyst", $sdkFeatures), @("macOS", "NetCore")),
    ...
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net11.0-android"), @("macOS", "NetCore")),

    # Ensure that build can happen even if a RID is specified
    @(3, "5.3/uno53net9blank/uno53net9blank/uno53net9blank.csproj", @("-f", "net11.0-android", "-r", "android-arm64"), @("macOS", "NetCore"))
    ...
    @(4, "5.3/uno53AppWithLib/uno53AppWithLib/uno53AppWithLib.csproj", @("-f", "net11.0-ios"), @("macOS", "NetCore")),
    @(4, "5.3/uno53AppWithLib/uno53AppWithLib/uno53AppWithLib.csproj", @("-f", "net11.0-android"), @("macOS", "NetCore")),
    @(4, "5.3/uno53AppWithLib/uno53AppWithLib/uno53AppWithLib.csproj", @("-f", "net11.0-maccatalyst"), @("macOS", "NetCore")),
