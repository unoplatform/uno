...
export UNO_UITEST_APP_ID="${UNO_UITEST_APP_ID:-uno.platform.unosampleapp}"
export UNO_UITEST_PLATFORM=Android
export UNO_UITEST_ANDROIDAPK_PATH="${UNO_UITEST_ANDROIDAPK_PATH:-$BUILD_SOURCESDIRECTORY/build/$SAMPLEAPP_ARTIFACT_NAME/android/$UNO_UITEST_APP_ID-Signed.apk}"
